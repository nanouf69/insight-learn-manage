    ...
    <div className="space-y-6 animate-fade-in">
            ...
            <div className="space-y-4 py-2 overflow-y-auto flex-1 min-h-0">
              ...
              {hasExistingAccount && !generatedPassword && (
                <div className="bg-muted p-3 rounded-md space-y-2">
                  ...
                  {(apprenant as any).mot_de_passe_plateforme && (
                    <div className="flex items-center gap-2">
                      <code className="text-sm bg-background px-2 py-1 rounded border">{(apprenant as any).mot_de_passe_plateforme}</code>
                      <Button variant="ghost" size="sm" onClick={() => { navigator.clipboard.writeText((apprenant as any).mot_de_passe_plateforme); toast.success("Copié !"); }}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsList className="flex flex-wrap w-full gap-0 bg-transparent border-b border-border rounded-none p-0 h-auto justify-start [&>button]:rounded-none [&>button]:border-b-2 [&>button]:border-transparent [&>button]:data-[state=active]:border-primary">
          ...
          <TabsTrigger value="emails" className="text-sm">Emails &amp; contacts</TabsTrigger>
        ...
        <div className="space-y-4">
          ...
          {/* Résultats */}
          {activeTab === "resultats" && (
            <ResultatsApprenantTab apprenantId={apprenant.id} />
          )}
