...
const FORMATIONS_CATALOGUE = [
  ...
  { label: "Formation initiale VTC avec frais d'examen - 1 499 €", prix: 1499, designation: "Formation initiale VTC avec frais d'examen - Préparation complète à la carte professionnelle chauffeur VTC" },
  ...
  { label: "Formation VTC E-learning avec examen - 1 499 €", prix: 1499, designation: "Formation initiale VTC en E-learning avec frais d'examen" },
