    ...
    try {
      if (type === 'inscription') {
        ...
        await generateAttestationFCVTC({
          ...
          adresse: apprenant.adresse || apprenant.financeur_adresse,
          codePostal: apprenant.code_postal || apprenant.financeur_code_postal,
          ville: apprenant.ville || apprenant.financeur_ville,
