...
export const FRANCAIS_EXERCICES: {
...
}[] = [
  {
    ...
    questions: [
      ...
      { id: 9, enonce: "Parmi ces verbes, lequel est du 2ème groupe ?", choix: [
      ...
      { id: 22, enonce: "Complétez : « Les filles sont parti__ à l'heure. »", choix: [
        { lettre: "A", texte: "parti" },
        { lettre: "B", texte: "partis" },
        { lettre: "C", texte: "parties", correct: true },
      ]},
      { id: 23, enonce: "Complétez : « Les fleurs qu'il a cueilli__ étaient belles. »", choix: [
        { lettre: "A", texte: "cueilli" },
        { lettre: "B", texte: "cueillis" },
        { lettre: "C", texte: "cueillies", correct: true },
      ]},
      { id: 24, enonce: "Complétez : « Les filles ont cueilli__ des fleurs. »", choix: [
        { lettre: "A", texte: "cueilli (pas d'accord)", correct: true },
        { lettre: "B", texte: "cueillies" },
      ]},
      { id: 25, enonce: "Complétez : « Ils se sont lavé__ les mains. »", choix: [
      ...
      { id: 30, enonce: "Complétez : « La cliente est arrivé__ en retard. »", choix: [
        { lettre: "A", texte: "arrivé" },
        { lettre: "B", texte: "arrivée", correct: true },
      ]},
      { id: 31, enonce: "Complétez : « Les bagages que j'ai pris__ étaient lourds. »", choix: [
      ...
      { id: 33, enonce: "Depuis combien de temps M. Dupont est-il chauffeur VTC ?", choix: [
      ...
      { id: 38, enonce: "Le transport de personnes est un métier de :", choix: [
      ...
      { id: 43, enonce: "Où Mme Lefèvre doit-elle se rendre ?", choix: [
      ...
      { id: 49, enonce: "Pourquoi le client est-il agacé au départ ?", choix: [
      ...
      { id: 54, enonce: "Qui délivre la carte professionnelle VTC ?", choix: [
      ...
      { id: 59, enonce: "De combien l'éco-conduite peut-elle réduire la consommation de carburant ?", choix: [
      ...
      { id: 64, enonce: "D'où vient M. Tanaka et pourquoi est-il à Lyon ?", choix: [
