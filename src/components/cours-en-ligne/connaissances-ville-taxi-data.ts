...
export const CONNAISSANCES_VILLE_TAXI_DATA: ModuleData = {
  ...
  cours: [
    ...
    },
    {
      ...
      fichiers: [{ nom: "Les Musées", url: "/cours/ville/11_Les_Musees.pdf?v=20260910" }],
    },
    {
      id: 12, actif: true,
      titre: "Les Parcs",
      ...
      fichiers: [{ nom: "Les Parcs", url: "/cours/ville/12_Les_Parcs.pdf?v=20260910" }],
    },
    {
      id: 13, actif: true,
      ...
      fichiers: [{ nom: "Les Personnalités", url: "/cours/ville/13_Les_Personnalites.pdf?v=20260910" }],
    },
    {
      id: 14, actif: true,
      ...
      fichiers: [{ nom: "Les Salles de Spectacles", url: "/cours/ville/14_Les_Salles_de_Spectacles.pdf?v=20260910" }],
    },
    {
      id: 15, actif: true,
      titre: "Les Vins",
      ...
      fichiers: [{ nom: "Les Vins", url: "/cours/ville/15_Les_Vins.pdf?v=20260910" }],
    },
    {
      id: 16, actif: true,
    ...
    },
    {
      ...
      fichiers: [{ nom: "Stations de Taxi", url: "/cours/ville/17_Stations_de_Taxi.pdf?v=20260910" }],
    },
  ],
  exercices: [
