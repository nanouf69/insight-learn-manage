...
export function isCalculQuestion(q: Question): boolean {
  ...
  const hasCalculKeyword =
    /\bcalcul(ez|er|ons|)\b/.test(enonceLC) || /\bamortiss/i.test(enonceLC) || /\bvaleur comptable\b/.test(enonceLC);
  ...
  questions: [
    {
      ...
      type: "QRC",
      enonce:
        "Je me fais contrôler sur la route, quels documents communs aux trois professions dois-je présenter aux forces de l'ordre ?",
      reponseQRC:
        "Le permis de conduire. La carte professionnelle. L'attestation de formation continue. Le certificat médical. L'attestation d'assurance du véhicule. L'attestation de responsabilité civile professionnelle (RCP).",
      reponses_possibles: [
        "permis de conduire",
    ...
    },
    {
      id: 2,
      type: "QRC",
      enonce: "Qu'est-ce que l'honorabilité dans votre profession ?",
    ...
    },
    {
      id: 4,
      type: "QRC",
      enonce: "Citez trois des conditions d'accès et/ou d'exercice aux professions de conducteurs de T3P :",
      reponseQRC:
        "Réussite à l'examen. Carte professionnelle en cours de validité. Formation continue. Aptitude médicale. Honorabilité. Assurance responsabilité civile professionnelle.",
      reponses_possibles: [
        "examen",
        "carte professionnelle",
        "formation continue",
    ...
    },
    {
      ...
      type: "QRC",
      enonce:
        "Quelles sont les sanctions possibles qui peuvent être décidées par les commissions disciplinaires locales ?",
    ...
    },
    {
      ...
      type: "QCM",
      enonce:
        "Parmi les entreprises du T3P, quelles sont celles soumises à l'obligation de s'assurer en responsabilité civile professionnelle ?",
      choix: [
    ...
    },
    {
      ...
      type: "QCM",
      enonce:
        "Parmi les condamnations suivantes, lesquelles peuvent être mentionnées au bulletin n°2 du casier judiciaire ?",
      choix: [
  ...
  questions: [
    {
      id: 1,
      type: "QRC",
      enonce: "Citez deux régimes de base de la protection sociale en France.",
    ...
    },
    {
      id: 2,
      type: "QRC",
      enonce: "Développez le sigle URSSAF.",
    ...
    },
    {
      id: 3,
      type: "QCM",
      enonce: "À l'actif du bilan figure :",
      choix: [
    ...
    },
    {
      id: 7,
      type: "QCM",
      enonce: "La libération totale du capital social dans une SARL doit intervenir au plus tard dans un délai de :",
      choix: [
    ...
    },
    {
      ...
      type: "QCM",
      enonce:
        "Au 1er janvier 2016, j'achète un véhicule 20 000€ HT amortissable sur 4 ans, et un ordinateur 600€ HT sur 3 ans. Quelle est la dotation d'amortissement déductible en 2017 ?",
      choix: [
    ...
    },
    {
      id: 15,
      type: "QCM",
      enonce: "Vous empruntez 25 000€ sur 5 ans, l'annuité est de 5 600€. Quel est le coût de l'emprunt ?",
      choix: [
  ...
  questions: [
    {
      ...
      type: "QCM",
      enonce:
        "Pour faire établir une nouvelle carte grise lors d'un changement de domicile, le propriétaire dispose de :",
      choix: [
    ...
    },
    {
      ...
      choix: [
        ...
        {
          lettre: "C",
          texte: "Laisser les clefs de contact sur le véhicule, après avoir éteint le moteur",
          correct: true,
        },
    ...
    },
    {
      id: 8,
      type: "QCM",
      enonce: "En roulant à 90 km/h, un conducteur doit laisser une distance de sécurité de :",
      choix: [
    ...
    },
    {
      id: 9,
      type: "QCM",
      enonce: "Conduire durant une période de suspension :",
      choix: [
    ...
    },
    {
      id: 13,
      type: "QCM",
      enonce: "Les témoins sur le tableau de bord qui alertent d'une urgence mécanique sont de couleur :",
      choix: [
    ...
    },
    {
      ...
      type: "QCM",
      enonce:
        'Mon permis porte la mention "verres correcteurs". Pour conduire, je peux porter des lentilles de contact :',
      choix: [
    ...
    },
    {
      id: 17,
      type: "QCM",
      enonce: "Rouler à 120 km/h au lieu de 130 km/h permet de réduire les émissions de CO2 :",
      choix: [
    ...
    },
    {
      id: 18,
      type: "QCM",
      enonce: "Quelles infractions entraînent un retrait de 4 points du permis de conduire ?",
      choix: [
...
Ainsi tout « écart » intempestif est considéré comme une agression à la propriété privée, et le conducteur exacerbé choisit d'extérioriser ce débordement très souvent par un comportement agressif et incivique. Cette manière d'être manifeste l'attitude habituelle ou circonstanciée du conducteur. L'attitude est déterminée par la situation de conduite qui se présente. L'attitude est porteuse de sens, sinon d'intentions, ce qui a permis de mettre en évidence les différents comportements routiers : à risque et sécuritaire.`,
  texteSource:
    "Questions Vives Recherches en éducation Vol. 9 n° 19 | 2013 — Éducation routière, changement de comportement et formation à la conduite",
  questions: [
    {
      id: 1,
      type: "QRC",
      ...
      reponseQRC:
        "La voiture est vécue comme une sphère privée, le prolongement de l'habitat, ce qui explique des comportements agressifs face à tout écart perçu comme une agression à la propriété privée.",
    ...
    },
    {
      ...
      reponseQRC:
        "L'attitude est porteuse de sens, sinon d'intentions, ce qui a permis de mettre en évidence les différents comportements routiers.",
      reponses_possibles: ["attitude", "comportements", "mise en évidence"],
    },
    {
      id: 3,
      type: "QRC",
      enonce: "Disposer d'une voiture est synonyme d'avantage selon vous. Développez votre réponse.",
      reponseQRC:
        "Oui : raccourcir le temps de trajet, liberté de déplacement. Mais cela crée aussi des comportements agressifs, de la pollution et des accidents.",
      reponses_possibles: ["temps de trajet", "liberté", "pollution", "accidents", "comportements"],
    },
    {
      id: 4,
      type: "QCM",
      enonce: "Selon l'auteur, après quel événement l'automobile est-elle devenue symbole de liberté individuelle ?",
      choix: [
    ...
    },
    {
      id: 8,
      type: "QCM",
      enonce: "D'après le texte, disposer d'une voiture pour l'homme signifie :",
      choix: [
...
const matiere_anglais_examen1: Matiere = {
  ...
  questions: [
    ...
    },
    {
      id: 3,
      type: "QCM",
      enonce: "Are you sure it is the shortest way? Traduisez :",
      choix: [
    ...
    },
    {
      id: 5,
      type: "QCM",
      enonce: "Ma voiture ne démarre pas. Traduisez en anglais :",
      choix: [
    ...
    },
    {
      id: 6,
      type: "QCM",
      enonce: "Votre séjour s'est-il bien passé ? En anglais :",
      choix: [
    ...
    },
    {
      id: 7,
      type: "QCM",
      enonce: "Your passenger plans to stay in Guadeloupe for a fortnight. Que veut dire 'fortnight' ?",
      choix: [
    ...
    },
    {
      id: 9,
      type: "QCM",
      enonce: "That's fine, keep the change. Traduisez :",
      choix: [
    ...
    },
    {
      id: 11,
      type: "QCM",
      enonce: "How long are you staying in town? Traduisez :",
      choix: [
    ...
    },
    {
      id: 12,
      type: "QCM",
      enonce: "Do you mind if I smoke in the car, sir? Traduisez :",
      choix: [
    ...
    },
    {
      id: 13,
      type: "QCM",
      enonce: "A quel nom dois-je établir la facture ? En anglais :",
      choix: [
    ...
    },
    {
      id: 14,
      type: "QCM",
      enonce: "No vacancies. Que signifie cette enseigne ?",
      choix: [
    ...
    },
    {
      id: 16,
      type: "QCM",
      enonce: "J'ai un avion demain matin à 10h20. En anglais :",
      choix: [
    ...
    },
    {
      id: 18,
      type: "QCM",
      enonce: "Sélectionnez la phrase correctement formulée :",
      choix: [
    ...
    },
    {
      id: 19,
      type: "QCM",
      enonce: "We will probably not make it on time. There's too much traffic. Traduisez :",
      choix: [
    ...
    },
    {
      id: 20,
      type: "QCM",
      enonce: "Avec une circulation normale, il faut 45 minutes pour atteindre l'aéroport. En anglais :",
      choix: [
  ...
  questions: [
    {
      id: 1,
      type: "QRC",
      enonce: "Développez le sigle TICPE.",
    ...
    },
    {
      id: 2,
      type: "QRC",
      enonce: "Je veux passer mon véhicule professionnel en véhicule personnel pour la journée que dois-je faire ?",
      reponseQRC: "Bâcher le lumineux. Éteindre le taximètre. Retirer la carte professionnelle.",
      reponses_possibles: ["bâcher", "lumineux", "éteindre", "taximètre", "retirer", "carte professionnelle"],
    },
    {
      id: 3,
      type: "QRC",
      enonce:
        "Lorsqu'un titulaire ne peut exploiter lui-même son autorisation de stationnement, quelles sont les deux possibilités qui s'offrent à lui pour que son entreprise reste active ?",
      reponseQRC: "La location du véhicule taxi à un conducteur de taxi. L'emploi d'un salarié.",
      reponses_possibles: ["location", "conducteur de taxi", "emploi", "salarié"],
    },
    {
      id: 4,
      type: "QRC",
      enonce: "Quelles sont les différentes autorités administratives compétentes pour délivrer une ADS ?",
      reponseQRC: "Les mairies.",
      reponses_possibles: ["mairies", "maire"],
    },
    {
      id: 5,
      type: "QCM",
      enonce:
        "Dans le cadre d'une cession d'autorisation, la condition tenant à l'exploitation effective et continue est justifiée :",
      choix: [
        { lettre: "A", texte: "par tout autre moyen défini par un arrêté de l'autorité compétente", correct: true },
        { lettre: "B", texte: "par la copie de l'autorisation de stationnement" },
        { lettre: "C", texte: "par la copie des déclarations de revenus ou d'avis d'imposition", correct: true },
        { lettre: "D", texte: "par la copie de la carte grise du véhicule" },
      ],
    },
    {
      id: 6,
      type: "QCM",
      enonce: "L'autorisation de stationnement délivrée postérieurement à la loi n°2014-1104 du 1er octobre 2014 :",
      choix: [
        { lettre: "A", texte: "a une durée de validité de 5 ans" },
        { lettre: "B", texte: "est cessible dans des conditions fixées par décret" },
        { lettre: "C", texte: "est renouvelable dans des conditions fixées par décret", correct: true },
        { lettre: "D", texte: "est cessible" },
      ],
    },
    {
      id: 7,
      type: "QCM",
      enonce: "Quelle autorité est compétente pour délivrer les autorisations de stationnement sur les aéroports ?",
      choix: [
        { lettre: "A", texte: "les présidents de chambres de métiers et de l'artisanat" },
        { lettre: "B", texte: "les présidents de chambres de commerce et d'industrie" },
        { lettre: "C", texte: "les préfets ou préfet de police dans leur zone de compétences", correct: true },
        { lettre: "D", texte: "les maires" },
      ],
    },
    {
      id: 8,
      type: "QCM",
      enonce: "Lorsque le client paye la course par carte bleue puis-je appliquer un supplément ?",
      choix: [
        { lettre: "A", texte: "non", correct: true },
        { lettre: "B", texte: "oui en accord avec le client" },
        { lettre: "C", texte: "oui sous certaines conditions" },
        { lettre: "D", texte: "oui" },
      ],
    },
    {
      id: 9,
      type: "QCM",
      enonce: "Le véhicule taxi :",
      choix: [
        { lettre: "A", texte: "peut être muni d'un terminal de paiement électronique selon la réglementation locale" },
        { lettre: "B", texte: "doit être muni d'un terminal de paiement électronique", correct: true },
        { lettre: "C", texte: "n'a pas l'obligation d'être muni d'un terminal de paiement électronique" },
      ],
    },
    {
      id: 10,
      type: "QCM",
      enonce: "Un transport vers l'hôpital non pris en charge par la caisse d'assurance maladie peut être effectué :",
      choix: [
        { lettre: "A", texte: "uniquement par les taxis non conventionnés" },
        { lettre: "B", texte: "par tous les taxis", correct: true },
        { lettre: "C", texte: "uniquement par les taxis conventionnés" },
      ],
    },
    {
      id: 11,
      type: "QCM",
      enonce: "Je veux faire du transport scolaire avec mon véhicule taxi que dois-je faire ?",
      choix: [
        { lettre: "A", texte: "afficher une pancarte transport d'enfants", correct: true },
        { lettre: "B", texte: "avoir un accompagnateur", correct: true },
        { lettre: "C", texte: "bâcher le lumineux", correct: true },
        { lettre: "D", texte: "retirer la carte professionnelle" },
      ],
    },
    {
      id: 12,
      type: "QCM",
      enonce: "Je mets en circulation un taxi de remplacement, quelle autorité dois-je aviser ?",
      choix: [
        { lettre: "A", texte: "la préfecture, la chambre de métiers, le RSI ou la CPAM et le service des fraudes" },
        { lettre: "B", texte: "la préfecture, la mairie de l'ADS remplacée, la CPAM et le service des fraudes" },
        {
          lettre: "C",
          texte:
            "la préfecture, la chambre de métiers, la CPAM dans le cas d'un taxi conventionné et le service des fraudes",
          correct: true,
        },
      ],
    },
    {
      ...
      type: "QCM",
      enonce:
        "Quelle est l'autorité compétente pour décider de l'usage de signe distinctif commun à l'ensemble des taxis ?",
      choix: [
        { lettre: "A", texte: "l'autorité compétente est exclusivement le préfet" },
        { lettre: "B", texte: "l'autorité compétente est exclusivement le maire" },
        {
          lettre: "C",
          texte: "l'autorité compétente est celle qui délivre les autorisations de stationnement",
          correct: true,
        },
      ],
    },
    {
      id: 14,
      type: "QCM",
      enonce: "Si le client vous demande une facture vous devez lui fournir :",
      choix: [
        { lettre: "A", texte: "l'original du ticket de l'imprimante et une facture", correct: true },
        { lettre: "B", texte: "une facture et une copie du ticket de l'imprimante" },
  ...
  questions: [
    {
      id: 1,
      type: "QRC",
      enonce: "Citez 4 stations de TAXI du 6ème arrondissement de Lyon.",
      reponseQRC:
        "Station Cours Vitton. Angle rue Masséna. Place du Général Leclerc. Entrée du parc de la Tête d'Or. Avenue du Général Brosset (Métro Brotteaux). Place du Maréchal Lyautey (Métro Foch).",
      reponses_possibles: ["Cours Vitton", "Général Leclerc", "Tête d'Or", "Brotteaux", "Maréchal Lyautey", "Masséna"],
    },
    {
      id: 2,
      type: "QRC",
      enonce: "Citez 4 mentions qui doivent être inscrites sur l'affichette TAXIS ?",
      reponseQRC:
        "Les taux horaires et kilométriques en vigueur. Les montants et conditions de la prise en charge et des suppléments. Les conditions de délivrance d'une note. L'information que le consommateur peut régler par carte bancaire. L'adresse de réclamation.",
      reponses_possibles: [
        "taux horaires",
        "kilométriques",
        "prise en charge",
    ...
    },
    {
      id: 3,
      type: "QCM",
      enonce: "Que signifie le tarif A ?",
      choix: [
        { lettre: "A", texte: "Course de jour" },
        { lettre: "B", texte: "Trajet aller avec le client et retour en charge à la station" },
        { lettre: "C", texte: "Course de nuit, dimanche et jours fériés ou route enneigée/verglacée" },
        { lettre: "D", texte: "Trajet aller avec le client et retour à vide à la station", correct: true },
      ],
    },
    {
      id: 4,
      type: "QCM",
      enonce: "Quel est le montant du supplément par passager ?",
      choix: [
        { lettre: "A", texte: "2 €" },
        { lettre: "B", texte: "2.50 €" },
        { lettre: "C", texte: "4 €", correct: true },
        { lettre: "D", texte: "3 €" },
      ],
    },
    {
      id: 5,
      type: "QCM",
      enonce: "Le supplément bagage est pour :",
      choix: [
        { lettre: "A", texte: "Les valises au-delà de trois" },
        { lettre: "B", texte: "Les valises au-delà de quatre" },
        { lettre: "C", texte: "Les valises au-delà de cinq", correct: true },
      ],
    },
    {
      id: 6,
      type: "QCM",
      enonce: "Où se situe le musée LUGDUNUM ?",
      choix: [
        { lettre: "A", texte: "46 allées d'Italie 69005" },
        { lettre: "B", texte: "2 rue Bichat 69005" },
        { lettre: "C", texte: "63 rue Philippe de Lassalle 69005" },
        { lettre: "D", texte: "17 rue Cléberg 69005", correct: true },
      ],
    },
    {
      id: 7,
      type: "QCM",
      enonce: "Quel est le prix au km du tarif C ?",
      choix: [
        { lettre: "A", texte: "2,31€" },
    ...
    },
    {
      id: 8,
      type: "QCM",
      enonce: "Où se situe la mairie de Villeurbanne ?",
      choix: [
        { lettre: "A", texte: "5 place du Petit Collège 69100" },
        { lettre: "B", texte: "6 place du Marché 69100" },
        { lettre: "C", texte: "16 place Jean Macé 69100" },
        { lettre: "D", texte: "place du Dr Lazarre Goujon 69100", correct: true },
      ],
    },
  ],
};
  ...
  questions: [
    {
      id: 1,
      type: "QRC",
      enonce: "Qu'est-ce qu'une plateforme de mise en relation (application VTC) ?",
      reponseQRC:
        "C'est une plateforme numérique qui met en relation des clients avec des conducteurs VTC. Elle n'est pas responsable du transport mais facilite la réservation.",
      reponses_possibles: ["plateforme", "mise en relation", "clients", "conducteurs", "réservation"],
    },
    {
      id: 2,
      type: "QRC",
      enonce: "Quels sont les documents obligatoires pour exercer en tant que VTC ?",
      reponseQRC:
        "La carte professionnelle VTC. L'attestation d'assurance. La carte grise du véhicule. Le certificat de visite technique.",
      reponses_possibles: ["carte professionnelle", "assurance", "carte grise", "contrôle technique"],
    },
    {
      id: 3,
      type: "QCM",
      enonce: "La carte professionnelle VTC est délivrée par :",
      choix: [
    ...
    },
    {
      id: 4,
      type: "QCM",
      enonce: "Un VTC peut-il stationner sur une borne de taxis ?",
      choix: [
    ...
    },
    {
      id: 5,
      type: "QCM",
      enonce: "La vignette distinctive obligatoire d'un VTC est de couleur :",
      choix: [
    ...
    },
    {
      id: 6,
      type: "QCM",
      enonce: "Un conducteur VTC peut-il prendre des clients en maraude (dans la rue) ?",
      choix: [
    ...
    },
    {
      id: 7,
      type: "QCM",
      enonce: "Quelle est la puissance fiscale minimale requise pour un véhicule VTC ?",
      choix: [
        { lettre: "A", texte: "5 CV" },
  ...
  questions: [
    {
      id: 1,
      type: "QCM",
      enonce: "Le registre des VTC (REVTC) est tenu par :",
      choix: [
    ...
    },
    {
      id: 2,
      type: "QCM",
      enonce: "La formation continue obligatoire pour les conducteurs VTC est de :",
      choix: [
    ...
    },
    {
      id: 3,
      type: "QCM",
      enonce: "Un VTC doit retourner à sa base ou dans un lieu non public entre deux courses. C'est :",
      choix: [
    ...
    },
    {
      id: 4,
      type: "QCM",
      enonce: "La capacité minimale d'un véhicule VTC est de :",
      choix: [
    ...
    },
    {
      id: 5,
      type: "QCM",
      enonce: "L'inscription au registre VTC doit être renouvelée :",
      choix: [
    ...
    questions: [
      {
        ...
        type: "QRC",
        enonce:
          "Je me fais contrôler sur la route quels documents communs aux trois professions dois-je présenter aux forces de l'ordre ? (QRC)",
        reponseQRC:
          "Le permis de conduire. La carte professionnelle. L'attestation de formation continue. Certificat médical. L'attestation d'assurance du véhicule. Attestation de responsabilité civile professionnelle (RCP - Transport de personnes à titre onéreux).",
        reponses_possibles: [
          "permis de conduire",
          "carte professionnelle",
          "attestation de formation",
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Que devez-vous présenter aux agents susceptibles d'effectuer des contrôles pour justifier d'une réservation préalable ? (QRC)",
        reponseQRC: "Un document écrit sur papier ou support électronique.",
      },
      {
        id: 4,
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Quelles sont les sanctions possibles qui peuvent être décidées par les commissions disciplinaires locales ? (QRC)",
        reponseQRC: "Un avertissement. Un retrait temporaire Un retrait définitif de la carte professionnelle.",
      },
      {
        id: 6,
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Parmi les entreprises du T3P, quelles sont celles qui sont soumises à l'obligation de s'assurer en responsabilité civile professionnelle ?",
        choix: [
          { lettre: "A", texte: "VTC et 2 ou 3 roues" },
      ...
      },
      {
        ...
        choix: [
          ...
          { lettre: "C", texte: "les préfectures", correct: true },
          {
            lettre: "D",
            texte:
              "le ministère des transports pour les VTC, le ministère de l’environnement pour les 2 ou 3 roues, le ministère de l’intérieur pour les taxis",
          },
        ],
      },
      {
        ...
        choix: [
          {
            lettre: "A",
            texte:
              "transporter et déposer des objets, déchets, liquides insalubres en un lieu sans l’autorisation de la personne ayant la jouissance du lieu",
          },
          {
            lettre: "B",
            texte: "conduire avec un taux d’alcool dans le sang de 0,8 gramme par litre ou plus",
            correct: true,
          },
          {
            lettre: "C",
            texte:
              "transporter un appareil permettant de déceler la présence de systèmes servant à la constatation des infractions à la législation, ou à la réglementation de la circulation routière",
          },
          {
            lettre: "D",
            texte: "poursuivre sa route, en connaissance de cause, après avoir occasionné un accident",
            correct: true,
          },
        ],
      },
    ...
    questions: [
      {
        ...
        reponses_possibles: ["Régimes spéciaux", "Régime général régime agricole"],
      },
      {
        id: 2,
        type: "QRC",
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "La libération totale du capital social dans une société à responsabilité limitée (SARL) doit intervenir au plus tard dans un délai de :",
        choix: [
          { lettre: "A", texte: "99 ans", correct: true },
          { lettre: "B", texte: "5 ans", correct: true },
          { lettre: "C", texte: "10 ans", correct: true },
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Vous empruntez 25 000 € sur une durée de 5 ans ; l'annuité est de 5 600 €. Quel le coût de l'emprunt ?",
        choix: [
          { lettre: "A", texte: "4200 €" },
    ...
    questions: [
      {
        ...
        choix: [
          { lettre: "A", texte: "Un stationnement à durée limitée" },
          {
            lettre: "B",
            texte:
              "Que du 1er au 15 de chaque mois, le stationnement est autorisé du coté des numéros impairs des immeubles bordant la rue",
            correct: true,
          },
          {
            lettre: "C",
            texte:
              "Que du 1 er au 15 de chaque mois, le stationnement est autorisé du coté des numéros pairs des immeubles bordant la rue",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "C",
            texte: "Laisser les clefs de contact sur le véhicule, après avoir eteint le moteur",
            correct: true,
          },
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          'Mon permis de conduire porte la mention "verres correcteurs" : pour conduire je peux porter des lentilles de contact :',
        choix: [
          {
            lettre: "A",
            texte: "Il est conseillé d'avoir à bord de mon véhicule des lunettes de rechange",
            correct: true,
          },
          { lettre: "B", texte: "Oui", correct: true },
          { lettre: "C", texte: "Non", correct: true },
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "B",
            texte: "Attention, danger : ne pas conduire. Pour la reprise de la conduite, demandez l’avis d’un médecin",
            correct: true,
          },
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Dans cette liste d'infractions, quelles sont celles qui entrainent un retrait de 4 points du permis de conduire ?",
        choix: [
          { lettre: "A", texte: "Utilisation du téléphone en conduisant" },
          { lettre: "B", texte: "Circulation en sens interdit", correct: true },
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Les témoins sur le tableaux de bord du véhicule qui alertent le conducteur d’une urgence mécanique sont de couleur :",
        choix: [
          { lettre: "A", texte: "Bleue" },
          { lettre: "B", texte: "Rouge", correct: true },
          { lettre: "C", texte: "Orange" },
...
Ainsi tout « écart » intempestif est considéré comme une agression à la propriété privée, et le conducteur exacerbé choisit d'extérioriser ce débordement très souvent par un comportement agressif et incivique. Cette manière d'être manifeste l'attitude habituelle ou circonstanciée du conducteur. L'attitude est déterminée par la situation de conduite qui se présente. L'attitude est porteuse de sens, sinon d'intentions, ce qui a permis de mettre en évidence les différents comportements routiers : à risque et sécuritaire.`,
    ...
    questions: [
      ...
      },
      {
        ...
        reponseQRC:
          "oui : raccourcir le temps de trajet, mais cela crée des comportements aggréssifis, pollution,accidents....",
      },
      {
        id: 4,
        type: "QCM",
    ...
    questions: [
      ...
      },
      {
        ...
        choix: [
          {
            lettre: "A",
            texte: "With a normal circulation, It must forty five minutes for attend the airport",
            correct: true,
          },
          { lettre: "B", texte: "In normal traffic, 45 minutes are needed for attent the airport" },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        reponseQRC:
          "Un apporteur d'affaires est une personne qui met en relation des personnes qui souhaitent réaliser entre elles des opérations commerciales.",
      },
      {
        id: 4,
        type: "QRC",
        ...
        reponseQRC:
          "Le coût de revient d'un produit ou d'une prestation est la somme des charges engagées pour la production d'un bien ou d'un service",
      },
      {
        id: 5,
        type: "QCM",
        ...
        choix: [
          {
            lettre: "A",
            texte:
              "le lien où des producteurs se rassemblent pour proposer directement leurs produits/prestations aux consommateurs",
          },
          { lettre: "B", texte: "le lien de rencontre physique ou virtuel de l'offre et de la demande" },
          {
            lettre: "C",
            texte: "l'ensemble des vendeurs et des acheteurs concernés par l'échange d'un bien ou d'un service",
            correct: true,
          },
        ],
      },
      ...
      },
      {
        ...
        choix: [
          {
            lettre: "A",
            texte: "l’envoi d’un message personnalisé à un groupe de personnes qualifiées",
            correct: true,
          },
    ...
    questions: [
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "C",
            texte: "les intermédiaires mettant en relation les exploitants et les clients",
            correct: true,
          },
        ],
      },
    ...
    questions: [
      ...
      },
      {
        ...
        enonce:
          "Je me fais contrôler sur la route quels documents communs aux trois professions dois-je présenter aux forces de l'ordre ? (QRC)",
        reponseQRC:
          "Le permis de conduire. La carte professionnelle en cours de validité. L'attestation de formation continue. Certificat médical. L'attestation d'assurance du véhicule. Attestation de responsabilité civile professionnelle (RCP - Transport de personnes à titre onéreux).",
        reponses_possibles: [
          "permis de conduire",
          "carte professionnelle",
          "attestation de formation",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Vous empruntez 25 000 € sur 5 ans, l'annuité (ce que l'on paie par an) est de 5 600 €. Quel est le coût de l'emprunt ?",
        choix: [
          { lettre: "A", texte: "4 200 €" },
          { lettre: "B", texte: "3 000 €", correct: true },
          { lettre: "C", texte: "3 600 €" },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Que risquez-vous en vous garant sur une place pour personne à mobilité réduite sans apposer la carte européenne de stationnement à l’intérieur du véhicule ?",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Hors agglomération, pour dépasser un cycliste, je dois laisser au minimum entre le cycliste et mon véhicule",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Je perds 2 points concernant une contravention de 2ème classe, je les récupère si je n’ai commis aucune autre infraction dans combien de temps ?",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Je me fais arrêter pour un test d'alcoolé­mie, je souffle et le résultat indique 0,30 mg/l d'air expiré, cette infraction est un délit.",
        choix: [
          { lettre: "A", texte: "Vrai" },
          { lettre: "B", texte: "Faux", correct: true },
        ],
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "En suivant un stage de sensibilisation à la sécurité routière, un conducteur qui a commis une infraction ayant donné lieu à un retrait de points peut retrouver :",
        choix: [
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "D",
            texte: "pour déterminer les responsabilités de chacune des personnes impliquées",
            correct: true,
          },
        ],
      },
...
Enfin, il existe un lien marqué entre la précarité, qui touche plus particulièrement les femmes, et les contraintes de mobilité qui contribuent à aggraver leur fragilité économique et sociale. Comment favoriser la mobilité des femmes précaires?`,
    texteSource:
      "Rapport d'information de Mmes Chantal JOUANNO et Christiane HUMMEL, fait au nom de la délégation aux droits des femmes n° 835 (2015-2016) — 20 septembre 2016",
    questions: [
      {
        id: 1,
        type: "QRC",
        enonce:
          "Expliquez en quoi la précarité touche plus particulièrement les femmes et en quoi les difficultés de mobilité aggravent la situation. Illustrez vos explications d'exemples personnels.(QRC)",
        reponseQRC:
          "En quoi la précarité touche plus particulièrement les femmes : travail à temps partiel, famille mono parentale, salaire plus bas. Mobilité et précarité : manque d'indépendance, ne peut répondre aux propositions intéressantes et plus éloignées (CDI), éloignement des lieux d'habitation par rapport au bassin d'emploi.",
      },
      {
        id: 2,
        type: "QRC",
        ...
        reponseQRC:
          "Bien que statistiquement les femmes ont moins d'accidents et sont plus prudentes, les clichés sont toujours là : les femmes sont peu habiles ou douées au volant, voire dangereuses.",
      },
      {
        id: 3,
        type: "QRC",
        enonce:
          "En quoi le permis de conduire est-il indispensable à l'insertion sociale des personnes d'après vous ? (QRC)",
        reponseQRC:
          "Ce qui est attendu : pour l'insertion sociale c'est la création et/ou l'entretien d'un réseau d'amis, de famille. Le permis de conduire permet d'accéder aux lieux de culture (cinéma, bibliothèque, …), administratifs pour réaliser ses démarches (allocations familiales, impôts, mairie,…).",
      },
      {
        id: 4,
        type: "QCM",
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Les auteures parlent d’un écart de 10 points entre les hommes et les femmes à l’examen du permis de conduire, cela signifie que :",
        choix: [
          { lettre: "A", texte: "les femmes réussissent d’avantage à l’examen du permis de conduire" },
          {
            lettre: "B",
            texte: "les hommes réussissent plus souvent l’examen du permis de conduire que les femmes",
            correct: true,
          },
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "« l’influence des stéréotypes masculins et féminins tout au long du parcours scolaire » a quelle(s) conséquence(s) selon les auteures ?",
        choix: [
          {
            lettre: "A",
            texte: "les filles ne s’orientent pas vers les filières techniques automobiles",
            correct: true,
          },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "A quoi sert la reformulation à la fin d'un échange pour une réservation (téléphonique ou face à face) ? (QRC)",
      ...
      },
      {
        ...
        reponseQRC:
          "Dans un premier temps je prends contact avec le client afin de lui demander son heure d’arrivée. En fonction de celle-ci je lui propose de lui réserver un autre VTC si j’ai une autre course prévue. Dans le cas contraire le client ayant réservé la course, je l’attends",
      },
      {
        id: 5,
        type: "QCM",
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "D",
            texte: "Au prix que le consommateur est prêt à payer pour acheter le produit/la prestation",
            correct: true,
          },
        ],
      },
      {
        ...
        choix: [
          {
            lettre: "A",
            texte: "multiplier les actions de prospections (e-mailling, carte de visite dans les hôtels, ... )",
            correct: true,
          },
    ...
    questions: [
      {
        ...
        type: "QRC",
        enonce:
          "Décrivez précisément les emplacements de la signalétique VTC sur un véhicule exploité comme voiture de transport avec chauffeur. (QRC)",
        reponseQRC:
          "En bas à gauche de la place chauffeur du pare-brise avant, angle du pare-brise arrière en bas à droite, à l'opposé de la place du chauffeur.",
      },
      {
        id: 2,
        type: "QRC",
        enonce:
          "De quelle couleur est la vignette qui doit figurer obligatoirement sur un véhicule de transport avec chauffeur ? Citez 2 éléments figurant sur cette vignette. (QRC)",
        reponseQRC:
          "La vignette est rouge, il est inscrit dessus le n° d’immatriculation du véhicule et le n° d’inscription au registre des VTC",
      },
      {
        id: 3,
        type: "QCM",
    ...
    questions: [
      {
        ...
        type: "QRC",
        enonce:
          "Quel est le poids maximal autorisé en charge (PTAC) d'un véhicule affecté au T3P et pour combien de places maximum ? Précisez avec ou sans chauffeur (QRC)",
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Si un chauffeur utilise son véhicule T3P dans le cadre d'une activité non-professionnelle que doit-il faire ?",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "A partir de quel montant minimal, le conducteur de T3P a-t-il l'obligation de fournir une note de course ?",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Les conducteurs de T3P bénéficient-ils d'un régime particulier au niveau de la limitation de vitesse ?",
        choix: [
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "B",
            texte: "doit-être apposée de telle manière que la photographie soit visible de l'extérieur",
            correct: true,
          },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Chaque année, l'expert-comptable ou le comptable remet au dirigeant son bilan et son compte de résultat. Expliquer ce que représentent ces deux documents. (QRC)",
        reponseQRC:
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Qu’est-ce que le PCG en comptabilité (document utilisé par les experts comptables pour votre comptabilité)) ?",
        choix: [
    ...
    questions: [
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "B",
            texte: "est réservé aux véhicules portant une carte de stationnement pour personnes handicapées",
            correct: true,
          },
          { lettre: "C", texte: "son occupation illicite est punie d’une contravention de troisième classe" },
          {
            lettre: "D",
            texte: "son occupation illicite fait encourir une mise en fourrière du véhicule",
            correct: true,
          },
        ],
      },
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Lorsque le permis a été invalidé en raison d'une perte totale de points, le nouveau permis obtenu est :",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Vous avez consommé de l’alcool. A l’issue d’un contrôle routier, votre taux est de 0,29 mg par litre d’air expiré. Que se passe-t-il ?",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Le niveau 3 des pictogrammes figurant sur les boîtes de médicament et alertant des risques en cas de conduite est de couleur :",
        choix: [
    ...
    questions: [
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "B",
            texte: "elles sont équipées d’un système qui leur permet d’échanger des informations entre elles",
          },
          {
            lettre: "C",
            texte:
              "les médias diffusent les démonstrations des voitures autonomes ce qui permet de faire de la publicité aux constructeurs",
            correct: true,
          },
        ],
      },
    ...
    questions: [
      ...
      },
      {
        ...
        choix: [
          {
            lettre: "A",
            texte: "pour les vols internationaux, les voyageurs prioritaires arrivent deux heures avant le départ",
          },
          {
            lettre: "B",
            texte: "pour les vols internationaux, les voyageurs doivent arriver deux heures avant le départ",
            correct: true,
          },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        reponseQRC:
          "Le contacter le plus rapidement possible, le rassurer, lui proposer de ramener son bien le plus surement et rapidement possible",
      },
      {
        id: 4,
        type: "QRC",
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Le conducteur de VTC propose, dans le cadre de sa mission, des prestations de standing auprès d’une clientèle haut de gamme. Pour ces raisons il doit tout mettre en œuvre afin de ne pas avoir une réputation usurpée et se distinguer des autres transporteurs de personnes en :",
        choix: [
          {
            lettre: "A",
            texte:
              "prenant en charge tous les clients avec qui il peut être rentable sans tenir compte de la qualité de la prestation",
          },
          {
            lettre: "B",
            texte:
              "optimisant sa structure, adoptant une attitude et un comportement professionnel et disposant d’un véhicule remarquable et remarqué",
            correct: true,
          },
          {
            lettre: "C",
            texte:
              "prenant en charge des clients sans tenir compte des valeurs du conducteur de VTC, ni de la norme de la profession",
          },
          {
            lettre: "D",
            texte:
              "utilisant un véhicule puissant, en bon état de propreté afin de déposer le client le plus rapidement possible au mépris des règles élémentaires",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        choix: [
          { lettre: "A", texte: "une brochure publicitaire référençant l’ensemble d'un catalogue de prestation" },
          {
            lettre: "B",
            texte:
              "une publicité sur format papier A5 ou plus petit permettant au conducteur de VTC de se faire connaître",
          },
    ...
    questions: [
      {
        ...
        reponseQRC:
          "En bas à gauche de la place chauffeur du pare-brise avant, angle du pare-brise arrière en bas à droite, à l'opposé de la place du chauffeur.En bas à gauche côté conducteur sur le par brise de devant En bas à droite à l'opposé du chauffeur sur le pare brise arrière",
      },
      {
        id: 2,
        type: "QRC",
        enonce: "Donnez la définition de l'activité de VTC (QRC)",
        reponseQRC:
          "Les activités de VTC sont « des exploitants qui mettent à la disposition de leur clientèle une ou p",
      },
      {
        id: 3,
        type: "QCM",
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "La prise en charge d'un client sur une voie ouverte à la circulation publique sans réservation préalable est :",
        choix: [
          ...
          {
            lettre: "C",
            texte: "un délit puni d'une peine de prison et d'une amende pouvant aller jusqu'à 15 000€",
            correct: true,
          },
        ],
      },
      {
        ...
        type: "QCM",
        enonce:
          "Parmi les dimensions suivantes, quelles sont celles qui permettent à une voiture d'être exploitée en VTC ?",
        choix: [
    ...
    questions: [
      {
        ...
        type: "QRC",
        enonce:
          "Une centrale de réservation doit justifier de l'existence d'un contrat d'assurance couvrant quel type de responsabilité ? (QRC)",
        reponseQRC:
          "Elle doit prouver l'existence d'un contrat d'assurance couvrant sa responsabilité civile professionnelle",
      },
      {
        id: 2,
        type: "QRC",
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Quel est le terme utilisé quand un conducteur de T3P prend en charge un client sur la voie publique sans réservation au préalable ? (QRC)",
      },
      {
        id: 4,
        type: "QRC",
        ...
        reponseQRC:
          "Service collectif dont l'itinéraire, les points d'arrêt, les fréquences les horaires, les tarifs sont fixés et publiés à l'avance.",
      },
      {
        id: 5,
        type: "QRC",
        enonce:
          "Citez deux cas dans lesquels la carte professionnelle peut être retirée à un conducteur du T3P ? (QRC)",
        reponseQRC:
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Pour s'inscrire à l'examen d'accès à la profession, le candidat ne doit pas avoir fait l'objet d'une exclusion pour fraude lors d'une session à un examen du T3P :",
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Un examen médical supplémentaire à celui exigé pour exercer la profession de conducteur peut être demandé :",
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "L'assurance dite responsabilité civile professionnelle (RCP) peut être invoquée par le conducteur s'il :",
      ...
      },
      {
        ...
        reponses_possibles: ["code préfectoral", "code des transports"],
      },
      {
        id: 13,
        type: "QCM",
        enonce:
          "Un artisan effectuant du T3P est victime d'un accident corporel de la circulation dans l'exercice de son activité, sous quel régime est-il ?",
        choix: [
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Un conducteur de transport public particulier de personnes n'effectuant que des remplacements épisodiques doit-il être titulaire d'une carte professionnelle ?",
    ...
    questions: [
      {
        ...
        type: "QRC",
        enonce:
          "Vous créez seul(e) une activité de transport de personnes. Quels sont les statuts juridiques possibles ? (citez-en trois) (QRC)",
        reponseQRC:
          "Entreprise Individuelle et/ou microentreprise Entreprise Unipersonnelle à Responsabilité Limitée EURL SASU",
      },
      {
        id: 2,
        type: "QRC",
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Un véhicule est acquis 22 000 € HT le 1er avril 2016. Calculez l'amortissement au 31/12/2016, en tenant compte d'une durée d'amortissement de 4 ans.",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Le cout de revient d'une prestation est de 22€, vous souhaitez réaliser une marge de 20% sur le prix de vente net de taxe, votre prix de vente net de taxe sera de :",
        choix: [
          { lettre: "A", texte: "26 €" },
    ...
    questions: [
      {
        ...
        choix: [
          ...
          {
            lettre: "B",
            texte: "Une obligation de céder le passage à la circulation venant en sens inverse",
            correct: true,
          },
        ...
        choix: [
          {
            lettre: "A",
            texte:
              "Lorsque le conducteur du véhicule qui me précède a signalé qu'il allait changer la direction vers la gauche",
            correct: true,
          },
          {
            lettre: "B",
            texte:
              "Lorsque le conducteur du véhicule qui me précède a signalé qu'il allait changer la direction vers la droite",
          },
          {
            lettre: "C",
            texte:
              "Lorsque le conducteur du véhicule qui me suit a signalé qu'il allait changer la direction vers la gauche",
          },
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "C",
            texte: "après réussite à la catégorie A lorsqu'il est titulaire de la catégorie B depuis plus de trois ans",
          },
        ],
      },
      {
        ...
        choix: [
          { lettre: "A", texte: "Il n'y a pas de conditions d'utilisation" },
          {
            lettre: "B",
            texte:
              "Il doit être placé sur la chaussée à une distance de 30 mètres environ du véhicule ou de l'obstacle à signaler",
            correct: true,
          },
          {
            lettre: "C",
            texte:
              "Il faut placer le triangle de signalisation même si cette action constitue une mise en danger manifeste de la vie du conducteur",
          },
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Pour dépasser un cycliste hors agglomération, le code de la route impose au conducteur de laisser un espace latéral :",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Le non-port de la ceinture de sécurité en voiture peut entraîner un retrait sur le permis de conduire de :",
        choix: [
    ...
    questions: [
      {
        ...
        type: "QRC",
        enonce:
          "Qu'est-ce qu'il faudrait faire pour faciliter l'interaction entre voitures autonomes et véhicules classiques ? (QRC)",
      ...
      },
      {
        ...
        reponseQRC:
          "Une place où l'on croise des vélos, des rollers, d'autres conducteurs humains, ou une route passant devant une école avec plein d'enfants.",
      },
      {
        id: 3,
        type: "QRC",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Vous travaillez avec une entreprise qui règle les prestations à 30 jours fin de mois. Si vous émettez votre facture le 2 mars, vous serez réglé le :",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Un chauffeur VTC, en EURL, fait un chiffre d'affaires de 50 000 €. Il a 10 000 € de charges sociales, a vendu son ancienne voiture 8 000 € HT et a payé 5 000 € de TVA. Quel est son résultat ?",
        choix: [
    ...
    questions: [
      {
        ...
        type: "QRC",
        enonce:
          "Le numéro d'inscription de l'entreprise au registre des VTC, le n° d'immatriculation du véhicule, le QR code (ou code barre bidimensionnel), le numéro de référence de la vignette (QRC)",
      ...
      },
      {
        id: 8,
        type: "QCM",
        enonce: "Quel est le délai de conservation obligatoire du registre de réservation pour un exploitant VTC ?",
        choix: [
          { lettre: "A", texte: "6 mois" },
          { lettre: "B", texte: "1 an" },
          { lettre: "C", texte: "2 ans", correct: true },
          { lettre: "D", texte: "5 ans" },
        ],
      },
    ],
  },
...
const eb5Matieres: Matiere[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Vous êtes chauffeur TAXI ou VTC en micro entreprise, quelles sanctions risquez vous si vous refusez de transporter une femme enceinte ? (QRC)",
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Comment se présente une réservation préalable ? Citez 2 mentions qui doivent figurer obligatoirement sur celle-ci ? (QRC)",
        reponseQRC:
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Pour être exploitable en activité de transport public particulier de personnes, un véhicule électrique doit être :",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Quelle est l'autorité qui effectue la vérification du casier judiciaire d'un candidat à la carte professionnelle de conducteur de véhicules T3P ?",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Quelle(s) profession(s) du T3P est/sont autorisée(s) à proposer leurs services immédiats sur la voie publique ?",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Quelles sont les collèges présents lors des commissions locales du T3P réunies en formation disciplinaire ?",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Quel est le nom de la formation obligatoire pour travailleur dans le secteur des personnes à mobilité réduite ?",
        choix: [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Un artisan achète un véhicule 21 000 € HT. Ce véhicule est amorti sur 3 ans. De combien sera l'amortissement annuel ? Détaillez votre calcul (QRC)",
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Un artisan au régime réel rembourse tous les mois depuis janvier, 930€ dont 620€ de capital, au titre de l'emprunt qu'il a souscrit. Quel est le montant des charges qu'il pourra déduire au 31 décembre ?",
        choix: [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          'Sur un trajet de 100 km sur autoroute, si je roule à 130 km/h au lieu de 120 km/h, je "gagne" environ :',
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Quelles sont les obligations expressément prévues par le code de la route, pour tout conducteur impliqué dans un accident de la circulation qui n'a provoqué que des dégâts matériels ?",
        choix: [
          {
            lettre: "A",
            texte: "Communiquer son identité et son adresse à toute personne impliquée dans l'accident",
            correct: true,
          },
          ...
          {
            lettre: "D",
            texte: "S’arrêter aussitôt que cela lui est possible, sans créer de danger pour la circulation",
            correct: true,
          },
        ],
      },
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Que risque un conducteur en cas de dépassement de la vitesse maximale autorisée compris entre 40 KM/h et moins de 50 km/h ?",
        choix: [
      ...
      },
      {
        ...
        choix: [
          { lettre: "A", texte: "Ont le droit de s'engager quelle que soit la vitesse et la distance des véhicules" },
          {
            lettre: "B",
            texte:
              "Doivent traverser la chaussée en tenant compte de la visibilité ainsi que de la distance et de la vitesse des véhicules",
            correct: true,
          },
          {
            lettre: "C",
            texte:
              "N'ont pas le droit de s'engager dans la traversée d'une chaussée hors d'un passage piéton, même s'il n'en n'existe pas à moins de 50 mètres",
          },
          {
            lettre: "D",
            texte:
              "Sont tenus d'utiliser, lorsqu'il en existe à moins de 50 mètres, les passages prévus à leur intention",
            correct: true,
          },
        ],
      },
      {
        ...
        type: "QCM",
        enonce:
          "Le décret n° 2016-448 du 13 avril 2016 modifiant certaines dispositions du code de la route relatives aux véhicules interdit les « vitres surteintées ». A cette fin, il impose :",
        choix: [
          {
            lettre: "A",
            texte: "un taux minimal de transparence de 70% sur les vitres avant et le pare-brise",
            correct: true,
          },
          {
            lettre: "B",
            texte: "un taux minimal de transparence de 80% sur les vitres avant, le pare-prise et les vitres arrières",
          },
          { lettre: "C", texte: "un taux minimal de transparence de 80% sur les vitres arrières et lunettes-arrières" },
          {
            lettre: "D",
            texte: "un taux minimal de transparence de 70% sur les vitres avant, le pare-prise et les vitres arrières",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "En agglomération, lorsque vous dépassez latéralement, un piéton ou un cycliste, vous devez laisser un espace d'au moins :",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Titulaire d'un permis probatoire, dans quel cas, devrais-je suivre obligatoirement un stage de sensibilisation à la sécurité routière :",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Vous êtes au volant de votre véhicule et recevez un appel sur votre téléphone portable. Vous prenez le téléphone en main, vous encourez :",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "En cas de récidive d'une conduite sous l'influence de substances ou de plantes classées comme stupéfiants, vous encourez :",
        choix: [
    ...
    questions: [
      {
        ...
        reponseQRC:
          "Parce que ce véhicule est censé être très résistent aux attaques extérieurs mais sa vitre a été cassé par l'envoi d'une balle d'acier.",
      },
      {
        id: 3,
        type: "QRC",
        enonce:
          "Si le pick-up Tesla n'était pas un peu polémique, ça ne serait pas une Tesla». Expliquez cette affirmation (QRC)",
        reponseQRC:
          "Tesla est une société qui cherche toujours d'apporter de la nouveauté et de l'innovation. Les polémiques et les scandales ne font qu'augmenter son succès.",
      },
      {
        id: 4,
        type: "QRC",
        ...
        reponseQRC:
          "véhicule 100% électrique, lignes très épurées, allure futuriste et cyberpunk, six places, capable de tracter sept tonnes et emporter 1.5 tonne, réalisé en acier inoxydable ultrarésistant, pourra passer de 0 à 100km/h en environ trois secondes",
      },
      {
        id: 5,
        type: "QCM",
    ...
    questions: [
      {
        ...
        reponseQRC:
          "Dans un premier temps je prends contact avec le client afin de lui demander son heure d'arrivée. En fonction de celle-ci je lui propose de lui réserver un autre VTC si j'ai une autre course de prévue. Dans le cas contraire le client ayant réservé la course, je l'attends.",
      },
      {
        id: 2,
        type: "QRC",
        enonce:
          "Le montant d'une prestation s'élève à 75 € TTC. Calculez le montant de la TVA et le prix HT, en détaillant vos calculs. (QRC)",
      ...
      },
      {
        ...
        reponseQRC:
          "Prospection traditionnelle (porte à porte, téléphone) ou prospection numérique (site web, mailing, réseaux sociaux, centrales de réservations)",
      },
      {
        id: 4,
        type: "QRC",
        enonce:
          "Vous connaissez un VTC qui va démarrer son activité avec des prix très bas afin d'attirer un maximum de clients. Que pensez-vous de cette politique tarifaire ? (QRC)",
        reponseQRC:
          "Politique tarifaire risquée : rentabilité diminuée, perception du client ( prix bas = qualité mauvaise? ), dégradation de l'image de la profession,....",
      },
      {
        id: 5,
        type: "QCM",
        enonce:
          "A l'aéroport, le parking professionnel est saturé alors que vos clients ne vont pas tarder à sortir du check out :",
        choix: [
        ...
        choix: [
          {
            lettre: "A",
            texte:
              "vous proposez de la raccompagner jusqu'à la porte de son appartement compte tenu de l'heure tardive",
          },
          {
            lettre: "B",
            texte:
              "vous la déposez devant la porte de son immeuble et attendez qu'elle soit rentrée dans son immeuble avant de repartir",
            correct: true,
          },
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Quelle démarche faut-il entreprendre pour pouvoir exploiter un véhicule électrique dérogeant aux caractéristiques techniques imposées aux véhicules VTC ? (QRC)",
        reponseQRC:
          "Il n'y a pas de démarche car un véhicule électrique n'a pas besoin de respecter des caractéristiques techniques pour être utilisé par un chauffeur VTC",
      },
      {
        id: 3,
        type: "QCM",
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "B",
            texte: "la publication du nom de l'entreprise dans la liste des exploitants sur le site du Ministère",
            correct: true,
          },
        ...
        choix: [
          {
            lettre: "A",
            texte:
              "les conditions générales de vente peuvent constituer un document valant contrat, sous réserve que le client ait dûment signé toutes les pages",
          },
          {
            lettre: "B",
            texte:
              "il doit exister un contrat avec le client final qui doit être obligatoirement écrit sur support papier",
          },
          {
            lettre: "C",
            texte:
              "il doit exister un contrat avec le client final pouvant être écrit sur support papier ou électronique",
            correct: true,
          },
          {
            lettre: "D",
            texte:
              "les conditions générales de vente peuvent constituer un document valant contrat, sous réserve que le client ait dûment signé la dernière page",
          },
        ],
      },
    ],
    ...
    questions: [
      {
        ...
        type: "QRC",
        enonce:
          "QUELLES SPÉCIFICITÉS DOIVENT FIGURER SUR LE CONTRAT D'ASSURANCE POUR EXERCER L'ACTIVITÉ DE TRANSPORT PARTICULIER DE PERSONNES (T3P) ? (QRC)",
      },
      {
        id: 3,
        type: "QRC",
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Le stage de formation continue dispensé aux conducteurs de transport public routier particulier de personnes permet d'obtenir une attestation valable :",
        choix: [
          { lettre: "A", texte: "5 ans", correct: true },
          { lettre: "B", texte: "1 an" },
          { lettre: "C", texte: "2 ans", correct: true },
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "B",
            texte: "abîme le vêtement de son passager en l'accompagnant jusqu'à son hôtel",
            correct: true,
          },
      ...
      },
      {
        ...
        choix: [
          {
            lettre: "A",
            texte: "La carte professionnelle mentionne la commune dans laquelle on est autorisé à exercer",
          },
          {
            lettre: "B",
            texte: "La carte professionnelle est délivrée par le Préfet ou le Préfet de Police",
            correct: true,
          },
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Le fait de ne pas présenter immédiatement sa carte professionnelle de conducteur lors d'un contrôle est passible :",
        choix: [
    ...
    questions: [
      {
        ...
        reponseQRC:
          "La responsabilité limitée concerne les conséquences financières d'une entreprise en cas de faillite , les sociétés ont une responsabilités limitées , cela signifie qu'en cas de faillite, c'est uniquement le patrimoine professionnel de la société qui pourra être saisi et non celui du gérant",
      },
      {
        id: 3,
        type: "QRC",
        enonce:
          "Lorsqu'un artisan vend son véhicule, expliquez comment est calculée la plus-value ou la moins-value réalisée (QRC)",
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Mes clients me payent 30 jours fin de mois. Pour une prestation réalisée le 5 avril, quand serai-je réglé ?",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "LE CHIFFRE D'AFFAIRES D'UN ARTISAN T3P PASSE DE 10 100 € À 15 440 €, L'ANNÉE SUIVANTE. QUEL EST LE POURCENTAGE D'AUGMENTATION ?",
        choix: [
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "C",
            texte: "L'entrepreneur individuel est responsable du paiement des dettes à hauteur du capital",
          },
        ],
      },
      {
        ...
        type: "QCM",
        enonce:
          "En micro entreprise en 2024, quel plafond de chiffre d'affaires je ne dois pas dépasser pour conserver ce statut",
        choix: [
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "C",
            texte: "l’impôt sur les revenus catégories Bénéfices Industriels et Commerciaux",
            correct: true,
          },
    ...
    questions: [
      {
        ...
        choix: [
          ...
          {
            lettre: "D",
            texte: "Ayant un poids total autorisé en charge (PTAC) qui n'excède pas 3.5 tonnes",
            correct: true,
          },
        ],
      },
      {
        ...
        type: "QCM",
        enonce:
          "Dans quel cas le conducteur doit-il réduire sa vitesse, même s'il est déjà en dessous de la vitesse maximale autorisée ?",
        choix: [
          ...
          {
            lettre: "C",
            texte: "Lors du croisement ou du dépassement de cyclistes isolés ou en groupe",
            correct: true,
          },
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "Le fait de ne pas présenter immédiatement son permis de conduire aux agents de l'autorité compétente est puni de :",
        choix: [
      ...
      },
      {
        ...
        type: "QCM",
        enonce:
          "En cas de dépassement de la vitesse maximale autorisée entre 30 km/h et moins de40 km/h, cette infraction donne lieu de plein droit à une réduction de nombre de points du permis de conduire de :",
        choix: [
...
Si pour le moment, la prestation reste chère, on peut imaginer qu'avec plusieurs bateaux, et si la clientèle est au rendez-vous, le prix d'une course pourrait baisser et se rapprocher des tarifs pratiqués par les taxis classiques, les bouchons en moins donc. Et comme le capitaine est un Lyonnais pur jus, amoureux de sa ville, il ne manquera pas de vous livrer quelques anecdotes sur la riche histoire de Lyon.`,
    ...
    questions: [
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Quelle(s) est (sont) la (les) condition(s) nécessaire(s) pour que le prix de la course de taxis-bateaux se rapproche des tarifs des taxis classiques ? (QRC)",
      ...
      },
      {
        ...
        reponseQRC:
          "Eviter les embouteillages, Aller partout en utilisant la voie d'eau pour se déplacer sur la ville de Lyon",
      },
      {
        id: 4,
        type: "QCM",
    ...
    questions: [
      ...
      },
      {
        ...
        choix: [
          ...
          {
            lettre: "B",
            texte: "je suis plus que désolé, mais vous serez en avance, il n'y a pas de bouchons en ce moment",
          },
          {
            lettre: "C",
            texte: "je suis extrêmement désolé, mais vous serez en retard, il y a des bouchons en ce moment",
            correct: true,
          },
        ],
      },
    ...
    questions: [
      {
        ...
        type: "QRC",
        enonce:
          "Je souhaite connaitre les entreprises de chauffeurs VTC présents sur la ville de Lyon, comment connaître ces informations ? (QRC)",
      ...
      },
      {
        ...
        type: "QRC",
        enonce:
          "Citez 4 caractéristiques d'un véhicule thermique que doit respecter un chauffeur VTC pour être en activité (QRC)",
        ...
        choix: [
          {
            lettre: "A",
            texte:
              "Exploitants qui mettent à la disposition de leur clientèle une ou plusieurs voitures de transport avec chauffeur dans des conditions fixées à l'avance entre les parties",
            correct: true,
          },
          {
            lettre: "B",
            texte:
              "Exploitants qui mettent à la disposition de leur clientèle une voitures de transport avec chauffeur sans conditions fixées à l'avance entre les parties",
          },
          {
            lettre: "C",
            texte:
              "Exploitants qui mettent à la disposition de leur clientèle une ou plusieurs voitures de transport avec chauffeur dans des conditions fixées à l'avance entre les deux parties",
          },
          {
            lettre: "D",
            texte:
              "Exploitants qui mettent à la disposition de leur clientèle une ou plusieurs véhicules de transport avec chauffeur dans des conditions fixées à l'avance entre les deux parties",
          },
        ],
      },
      {
        ...
        choix: [
          {
            lettre: "A",
            texte: "La copie de la carte grise lorsque l’exploitant est propriétaire du véhicule,",
            correct: true,
          },
          { lettre: "B", texte: "La copie de la page signée du contrat de location ou de crédit bail (leasing)" },
          {
            lettre: "C",
            texte: "La copie de la page signée du contrat de location ou de crédit bail (leasing) d'au moins 6 mois",
            correct: true,
          },
          {
            lettre: "D",
            texte:
              "Si le véhicule a déjà donné lieu à une justification de capacité financière, l’exploitant doit le signaler au registre en indiquant le numéro SIRET ou SIREN correspondant à l’exploitant ayant déjà déclaré ce véhicule ainsi que le numéro d’immatriculation (carte grise) du véhicule concerné.",
            correct: true,
          },
        ],
      },
      {
        ...
        type: "QCM",
        enonce:
          "Quel est le délai maximum pour prévenir le registre des VTC en cas de modification des informations enregistrées sur le registre des VTC ?",
        choix: [
...
const bilan_reglementation_taxi_specifique: Matiere = {
  ...
  questions: [
      ...
      choix: [
        {
          lettre: "A",
          texte:
            "Par tout autre moyen défini par un arrêté de l'autorité compétente pour délivrer l'ADS (contrat de location, bilan comptable, copie de l'arrêté initiale)",
          correct: true,
        },
        { lettre: "B", texte: "Par la copie de l'autorisation de stationnement" },
        { lettre: "C", texte: "Par la copie des déclarations de revenus ou d'avis d'imposition", correct: true },
        { lettre: "D", texte: "Par la copie de la carte grise du véhicule utilisé pour l'activité taxi" },
      ],
    },
    {
      id: 2,
      type: "QCM",
      enonce:
        "L'autorisation de stationnement délivrée postérieurement à la publication de la loi n°2014-1104 du 1er octobre 2014 :",
      choix: [
        { lettre: "A", texte: "A une durée de validité de 5 ans", correct: true },
        { lettre: "B", texte: "Est cessible dans des conditions fixées par décret" },
        { lettre: "C", texte: "Est renouvelable dans des conditions fixées par décret", correct: true },
        { lettre: "D", texte: "Est cessible" },
      ],
    ...
    },
    {
      ...
      type: "QCM",
      enonce:
        "Depuis l'entrée en vigueur de la loi du 1er octobre 2014, la demande de renouvellement d'une ADS délivrée postérieurement à cette date doit être réalisée :",
      choix: [
        { lettre: "A", texte: "3 mois avant le terme", correct: true },
        { lettre: "B", texte: "Avant l'échéance du terme" },
        { lettre: "C", texte: "1 mois avant le terme" },
        { lettre: "D", texte: "6 mois avant le terme" },
      ],
    },
    {
      id: 5,
    ...
    },
    {
      ...
      type: "QCM",
      enonce:
        "Un transport vers l'hôpital ou un cabinet médical non pris en charge par la caisse d'assurance maladie peut être effectué :",
      choix: [
        { lettre: "A", texte: "Uniquement par les taxis non conventionnés" },
        { lettre: "B", texte: "Par tous les taxis", correct: true },
        { lettre: "C", texte: "Uniquement par les taxis conventionnés" },
    ...
    },
    {
      ...
      type: "QCM",
      enonce:
        "Nul ne peut s'inscrire à l'examen en vue de la délivrance du certificat de capacité professionnelle de conducteur de taxi :",
      choix: [
        {
          lettre: "A",
          texte: "S'il a fait l'objet dans les dix ans qui précèdent sa demande, d'une exclusion pour fraude",
          correct: true,
        },
        {
          lettre: "B",
          texte: "S'il a fait l'objet dans les cinq ans qui précèdent sa demande, d'une exclusion pour fraude",
        },
        {
          lettre: "C",
          texte:
            "S'il a fait l'objet dans les cinq ans qui précèdent sa demande, d'un retrait définitif de la carte professionnelle",
        },
        {
          lettre: "D",
          texte:
            "S'il a fait l'objet dans les dix ans qui précèdent sa demande, d'un retrait définitif de la carte professionnelle",
          correct: true,
        },
      ],
    },
    {
      ...
      enonce: "Je veux faire du transport scolaire avec mon véhicule taxi que dois-je faire ?",
      choix: [
        { lettre: "A", texte: "Afficher une pancarte transport d'enfants" },
        { lettre: "B", texte: "Avoir un accompagnateur" },
        { lettre: "C", texte: "Bâcher le lumineux", correct: true },
        { lettre: "D", texte: "Retirer la carte professionnelle" },
      ],
    },
      ...
      choix: [
        {
          lettre: "A",
          texte:
            "La préfecture, la CMA, le RSI ou la CPAM dans le cas du statut de l'artisan et le service des fraudes",
        },
        {
          lettre: "B",
          texte:
            "La préfecture, la mairie de l'ADS remplacée, la CPAM dans le cas d'un taxi conventionné et le service des fraudes",
        },
        {
          lettre: "C",
          texte: "La préfecture, la CMA, la CPAM dans le cas d'un taxi conventionné et le service des fraudes",
          correct: true,
        },
        {
          lettre: "D",
          texte:
            "La préfecture, le conseil départemental, la CPAM dans le cas d'un taxi conventionné et le service des fraudes",
        },
      ],
    },
    {
      ...
      type: "QCM",
      enonce:
        "Quelle est l'autorité compétente pour décider de l'usage de signe distinctif commun à l'ensemble des taxis, notamment une couleur unique ?",
      choix: [
        { lettre: "A", texte: "L'autorité compétente est exclusivement le préfet" },
        { lettre: "B", texte: "L'autorité compétente est exclusivement le maire" },
        {
    ...
    },
    {
      ...
      enonce: "Si le client vous demande une facture vous devez lui fournir :",
      choix: [
        { lettre: "A", texte: "Une facture et une copie du ticket de l'imprimante" },
        { lettre: "B", texte: "Une copie du ticket de l'imprimante" },
        { lettre: "C", texte: "L'original du ticket de l'imprimante", correct: true },
      ],
    },
    {
      id: 13,
      type: "QCM",
      enonce: "Par quel texte réglementaire national sont modifiés les tarifs des courses de taxi ?",
      choix: [
        { lettre: "A", texte: "Un décret" },
        { lettre: "B", texte: "Une loi" },
        { lettre: "C", texte: "Un arrêté", correct: true },
      ],
    },
    {
      id: 14,
      type: "QCM",
      enonce:
        "Un conducteur de taxi peut-il prendre en charge un client dans une commune autre que celle dans laquelle il exploite l'autorisation de stationner ?",
      choix: [
        { lettre: "A", texte: "Non, en aucun cas" },
        { lettre: "B", texte: "Oui, s'il a fait l'objet d'une réservation préalable", correct: true },
        { lettre: "C", texte: "Oui, s'il demeure dans cette commune" },
      ],
    },
    {
      id: 15,
      type: "QCM",
      enonce: "Quel est l'emplacement du taximètre ?",
      choix: [
        {
          lettre: "A",
          texte: "Installé à l'intérieur avant du véhicule, à la portée du conducteur et visible des clients",
          correct: true,
        },
        { lettre: "B", texte: "Installé sur le toit à l'extérieur du véhicule" },
        { lettre: "C", texte: "Installé à l'intérieur du véhicule, sur l'aile droite et fixé par des vis" },
        { lettre: "D", texte: "Installé à l'intérieur du véhicule, sur le pare-brise arrière côté droit" },
      ],
    },
    {
      id: 16,
      type: "QCM",
      enonce: "Qui décide du montant de la taxe de stationnement ?",
      choix: [
        { lettre: "A", texte: "Le trésor public" },
        { lettre: "B", texte: "La préfecture" },
        { lettre: "C", texte: "Le maire et son conseil municipal", correct: true },
        { lettre: "D", texte: "Le ministère de l'économie" },
      ],
    },
    {
      id: 17,
      type: "QCM",
      enonce: "Est-il possible pendant une course de changer le tarif au taximètre et à quelle condition ?",
      choix: [
        { lettre: "A", texte: "Oui, sans condition" },
        { lettre: "B", texte: "Non, jamais" },
        { lettre: "C", texte: "Oui, au changement d'heure (jour/nuit) en prévenant le client", correct: true },
        { lettre: "D", texte: "Oui, à la demande du client" },
      ],
    },
    {
      id: 18,
      type: "QCM",
      enonce: "Où doit-on adresser une demande de détaxe de carburants ?",
      choix: [
        { lettre: "A", texte: "À la Direction Départementale des Territoires et de la Mer" },
        { lettre: "B", texte: "À la Direction des Douanes", correct: true },
        { lettre: "C", texte: "Au bureau des taxis de la Préfecture" },
      ],
    },
    {
      id: 19,
      type: "QCM",
      enonce: "Le véhicule taxi doit être muni d'une plaque :",
      choix: [
        { lettre: "A", texte: "Indiquant l'adresse de la préfecture" },
        { lettre: "B", texte: "Indiquant le numéro de l'autorisation de stationnement", correct: true },
        { lettre: "C", texte: "Indiquant le nom du propriétaire de l'ADS" },
        { lettre: "D", texte: "Visible de l'extérieur", correct: true },
      ],
    },
    {
      id: 20,
      type: "QCM",
      enonce: "Quelles sont les composantes des tarifs des courses de taxi ?",
      choix: [
        { lettre: "A", texte: "Indemnité horaire, indemnité kilométrique, heure d'attente" },
        { lettre: "B", texte: "Indemnité horaire, prise en charge, marche lente" },
        {
          lettre: "C",
          texte: "Prise en charge, indemnité kilométrique, heure d'attente ou marche lente",
          correct: true,
        },
      ],
    },
    {
      ...
      type: "QCM",
      enonce:
        "À quelle périodicité un conducteur de taxi doit-il renouveler sa demande d'inscription sur la liste d'attente en vue de l'obtention d'une licence gratuite ?",
      choix: [
        { lettre: "A", texte: "Tous les 2 ans" },
        { lettre: "B", texte: "C'est automatique" },
    ...
    },
    {
      id: 22,
      type: "QCM",
      enonce: "En cas de changement de tarif, sous quel délai le chauffeur doit-il modifier son compteur ?",
      choix: [
        { lettre: "A", texte: "2 mois" },
        { lettre: "B", texte: "1 mois", correct: true },
        { lettre: "C", texte: "3 mois" },
      ],
    },
    {
      ...
      type: "QCM",
      enonce:
        "Chaque intervention sur les équipements spéciaux des taxis doit être consignée sur un carnet spécifique, comment s'appelle ce document ?",
      choix: [
        { lettre: "A", texte: "Carnet d'entretien du véhicule" },
        { lettre: "B", texte: "Carnet d'intervention spécifique" },
        { lettre: "C", texte: "Carnet métrologique", correct: true },
      ],
    },
    {
      id: 24,
      type: "QCM",
      enonce: "Que signifie CPAM ?",
      choix: [
        { lettre: "A", texte: "Caisse primaire d'assurance maternité" },
        { lettre: "B", texte: "Caisse primaire d'assurance maladie", correct: true },
        { lettre: "C", texte: "Caisse principe d'assurance maladie" },
        { lettre: "D", texte: "Caisse primordiale d'assurance maternité" },
      ],
    },
    {
      id: 25,
      type: "QCM",
      enonce: "Quelle sanction risque-t-on en cas d'absence de taximètre conforme ?",
      choix: [
        { lettre: "A", texte: "3ème classe" },
        { lettre: "B", texte: "2ème classe" },
        { lettre: "C", texte: "1ère classe", correct: true },
      ],
    },
    {
      id: 26,
      type: "QCM",
      enonce: "L'activité de taxi fait partie :",
      choix: [
        { lettre: "A", texte: "Du transport public collectif de personnes" },
        { lettre: "B", texte: "Du transport public particulier de personnes", correct: true },
        { lettre: "C", texte: "Du transport privé de personnes" },
      ],
    },
    {
      id: 27,
      type: "QCM",
      enonce:
        "Quelle sanction risque-t-on en cas d'absence d'imprimante connectée au taximètre permettant l'édition d'une note d'information du prix ?",
      choix: [
        { lettre: "A", texte: "3ème classe" },
        { lettre: "B", texte: "2ème classe" },
        { lettre: "C", texte: "1ère classe", correct: true },
    ...
    },
    {
      id: 28,
      type: "QCM",
      enonce: "Quel(s) statut(s) permet d'exploiter l'autorisation de stationnement de la société ?",
      choix: [
        { lettre: "A", texte: "Taxi Salarié", correct: true },
        { lettre: "B", texte: "Taxi coopérateur" },
        { lettre: "C", texte: "Locataire gérant", correct: true },
        { lettre: "D", texte: "Artisan" },
      ],
    },
    {
      id: 29,
      type: "QCM",
      enonce:
        "Quelle sanction risque-t-on en cas d'exercice illégal de l'activité : absence d'autorisation de stationnement ?",
      choix: [
        { lettre: "A", texte: "3ème classe" },
        { lettre: "B", texte: "5ème classe" },
        { lettre: "C", texte: "Délit", correct: true },
      ],
    },
    {
      id: 30,
      type: "QCM",
      enonce: "Quels éléments ne figurent pas sur le recto de la carte TAXI ?",
      choix: [
        { lettre: "A", texte: "Le code à barres bidimensionnel et la mention « 2D-DOC »" },
        { lettre: "B", texte: "Le prénom du conducteur" },
        { lettre: "C", texte: "Le numéro de la carte" },
        { lettre: "D", texte: "La signature du conducteur", correct: true },
      ],
    },
    {
      id: 31,
      ...
      choix: [
        ...
        { lettre: "B", texte: "La préfecture" },
        { lettre: "C", texte: "La métropole" },
      ],
    },
    {
      id: 32,
      type: "QCM",
      enonce: "Je peux revendre (hors cas dérogatoires) ma licence si je l'ai achetée au bout de :",
      choix: [
        { lettre: "A", texte: "5 ans", correct: true },
        { lettre: "B", texte: "1 an" },
    ...
    },
    {
      id: 33,
      type: "QCM",
      enonce: "Quels types de transports collectifs puis-je effectuer en tant que taxi si je suis inscrit à la DREAL ?",
      choix: [
        { lettre: "A", texte: "Services réguliers" },
        { lettre: "B", texte: "Services occasionnels", correct: true },
        { lettre: "C", texte: "Services à la demande" },
      ],
    },
    {
      id: 34,
      type: "QCM",
      enonce: "Qui s'occupe du nettoyage du véhicule en location gérance ?",
      choix: [
        { lettre: "A", texte: "Le propriétaire" },
        { lettre: "B", texte: "Le locataire", correct: true },
      ],
    },
    {
      id: 35,
      type: "QCM",
      enonce: "Les tarifs imposés par la préfecture de police est un tarif :",
      choix: [
        { lettre: "A", texte: "Imposé" },
        { lettre: "B", texte: "Maximum", correct: true },
        { lettre: "C", texte: "Minimum" },
      ],
    },
    {
      id: 36,
      type: "QCM",
      enonce: "Quelle(s) est/sont la/les prestation(s) dont le conducteur artisan de taxi peut bénéficier ?",
      choix: [
        { lettre: "A", texte: "Les allocations familiales", correct: true },
        { lettre: "B", texte: "La retraite de base", correct: true },
        { lettre: "C", texte: "L'indemnité chômage" },
        { lettre: "D", texte: "L'indemnité journalière de maladie", correct: true },
      ],
    },
    {
      id: 37,
      type: "QCM",
      enonce: "Un conducteur de taxi peut-il transporter des colis non accompagnés ?",
      choix: [
        { lettre: "A", texte: "Non, c'est interdit" },
        { lettre: "B", texte: "Oui, à condition que le conducteur fasse une pause" },
        { lettre: "C", texte: "Non, même s'il y a un contrat d'assurance" },
        { lettre: "D", texte: "Oui, mais le conducteur se fait payer à l'arrivée", correct: true },
      ],
    },
    {
      id: 38,
      type: "QCM",
      enonce: "Qu'est-ce qu'un carnet métrologique ?",
      choix: [
        { lettre: "A", texte: "Un certificat de conformité de l'installation du taximètre", correct: true },
        { lettre: "B", texte: "Un livre" },
        { lettre: "C", texte: "Un carnet de liaison entre l'installateur du matériel et le taxi" },
        { lettre: "D", texte: "Un cahier de notes" },
      ],
    },
    {
      id: 39,
      type: "QCM",
      enonce: "Où doit être apposée la carte professionnelle d'un conducteur de taxi ?",
      choix: [
        { lettre: "A", texte: "Sur le pare-brise avant côté passager" },
        { lettre: "B", texte: "Dans le véhicule, tant qu'elle est lisible du siège arrière" },
        { lettre: "C", texte: "Sur le pare-brise avant côté conducteur", correct: true },
      ],
    },
    {
      id: 40,
      type: "QCM",
      enonce:
        "Lors de la cession d'une ADS, quel document permet au vendeur de justifier qu'elle a bien été exploitée de manière effective et continue ?",
      choix: [
        { lettre: "A", texte: "Un certificat médical délivré par un médecin agréé" },
        { lettre: "B", texte: "La carte grise du véhicule" },
        { lettre: "C", texte: "Les avis d'imposition de la période concernée", correct: true },
      ],
    },
    {
      id: 41,
      type: "QCM",
      enonce: "Les autorisations de stationnement délivrées depuis la loi du 1er octobre 2014 :",
      choix: [
        { lettre: "A", texte: "Peuvent être exploitées par des sociétaires de coopératives" },
        { lettre: "B", texte: "Doivent être exploitées personnellement", correct: true },
        { lettre: "C", texte: "Peuvent être exploitées par des salariés" },
        { lettre: "D", texte: "Peuvent être exploitées par des locataires-gérants" },
      ],
    },
    {
      id: 42,
      type: "QCM",
      enonce: "Un compteur horokilométrique permet :",
      choix: [
        { lettre: "A", texte: "De calculer le montant de la course", correct: true },
        { lettre: "B", texte: "D'afficher la durée de la course" },
        { lettre: "C", texte: "D'afficher le nombre de kilomètres parcourus" },
      ],
    },
    {
      id: 43,
      type: "QCM",
      enonce: "Le véhicule taxi doit être muni d'un terminal de paiement électronique :",
      choix: [
        { lettre: "A", texte: "Si le préfet du département le prévoit par arrêté" },
        { lettre: "B", texte: "C'est une obligation légale valable sur tout le territoire national", correct: true },
        {
          lettre: "C",
          texte: "Uniquement pour les taxis exerçant leur activité dans les zones touristiques",
        },
      ],
    },
    {
      ...
      type: "QCM",
      enonce:
        "Le registre de disponibilité des taxis fait l'objet d'un enregistrement d'informations relatives aux ADS lors :",
      choix: [
        { lettre: "A", texte: "Des changements des équipements spéciaux" },
        { lettre: "B", texte: "Des renouvellements et des ventes d'ADS", correct: true },
        { lettre: "C", texte: "Des formations quinquennales obligatoires" },
        { lettre: "D", texte: "Des délivrances et des retraits d'ADS", correct: true },
      ],
    },
    {
      id: 45,
      type: "QCM",
      enonce: "Le conducteur de taxi a le droit :",
      choix: [
        {
          lettre: "A",
          texte: "De ne pas attendre les voyageurs s'ils se trouvent dans une voie où le stationnement est impossible",
          correct: true,
        },
        { lettre: "B", texte: "D'être accompagné de personnes autres que des clients" },
        { lettre: "C", texte: "De solliciter un pourboire" },
      ],
    },
    {
      id: 46,
      type: "QCM",
      enonce: "Le financement en crédit-bail d'un véhicule de taxi permet la déduction fiscale :",
      choix: [
        { lettre: "A", texte: "Des loyers du crédit-bail", correct: true },
        { lettre: "B", texte: "De l'amortissement du véhicule" },
        { lettre: "C", texte: "Des intérêts et de l'assurance décès / incapacité / invalidité" },
      ],
    },
    {
      id: 47,
      type: "QCM",
      enonce:
        "Quelle(s) mention(s) ne doit(vent) pas figurer sur le registre des transactions quand le titulaire d'une ADS présente un successeur à titre onéreux ?",
      choix: [
        { lettre: "A", texte: "Le nom ou la raison sociale du successeur ou du vendeur" },
        { lettre: "B", texte: "Le numéro d'inscription à la chambre des métiers et de l'artisanat" },
        { lettre: "C", texte: "Le montant de la transaction", correct: true },
        { lettre: "D", texte: "La marque de la voiture", correct: true },
      ],
    },
    {
      id: 48,
      type: "QCM",
      enonce: "La plus-value est égale à :",
      choix: [
        { lettre: "A", texte: "La différence entre le prix de vente et le prix d'achat ou de la valeur déclarée" },
        {
          lettre: "B",
          texte: "L'addition entre le prix de vente et le prix d'achat ou de la valeur déclarée",
          correct: true,
        },
        { lettre: "C", texte: "La différence entre les bénéfices et le prix d'achat ou de la valeur déclarée" },
      ],
    },
    {
      id: 49,
      type: "QCM",
      enonce: "La TVA à décaisser (à payer) représente :",
      choix: [
        { lettre: "A", texte: "La TVA" },
        { lettre: "B", texte: "TVA collectée − TVA déductible" },
        { lettre: "C", texte: "TVA déductible − TVA collectée", correct: true },
      ],
    },
    {
      id: 50,
      type: "QCM",
      enonce:
        "Si l'on se met en face d'un dispositif lumineux TAXI et que l'on lit de droite à gauche, quel est l'ordre des lettres ?",
      choix: [
        { lettre: "A", texte: "ABCD" },
        { lettre: "B", texte: "DCBA", correct: true },
        { lettre: "C", texte: "ABDC" },
        { lettre: "D", texte: "CDBA" },
      ],
    },
    {
      id: 51,
      type: "QCM",
      enonce: "Quelle est la couleur des lettres du dispositif lumineux TAXI DCBA ?",
      choix: [
        { lettre: "A", texte: "Vert, bleu, orange, blanc", correct: true },
        { lettre: "B", texte: "Vert, bleu, orange, marron" },
        { lettre: "C", texte: "Orange, blanc, vert, bleu" },
        { lettre: "D", texte: "Bleu, vert, blanc, orange" },
      ],
    },
    {
      id: 52,
      type: "QCM",
      enonce: "Qu'est-ce qu'un LOGO ?",
      choix: [
        { lettre: "A", texte: "Un jeu pour enfants" },
        { lettre: "B", texte: "Un graphisme qui représente une marque ou une société", correct: true },
        { lettre: "C", texte: "Une marionnette" },
        { lettre: "D", texte: "Une affiche" },
      ],
    },
    {
      id: 53,
    ...
    },
    {
      ...
      enonce: "On appelle marketing direct :",
      choix: [
        { lettre: "A", texte: "L'envoi d'un message personnalisé à un groupe de personnes ciblées", correct: true },
        { lettre: "B", texte: "L'achat d'espace publicitaire dans la presse locale" },
        { lettre: "C", texte: "La mise en valeur d'offres promotionnelles dans le véhicule" },
      ],
    },
    {
      ...
      choix: [
        { lettre: "A", texte: "Une brochure publicitaire référençant l'ensemble d'un catalogue de prestation" },
        { lettre: "B", texte: "Une publicité sur format papier A5 ou plus petit" },
        { lettre: "C", texte: "Un client potentiel", correct: true },
        { lettre: "D", texte: "L'ensemble des clients non facturés uniquement" },
      ],
    },
    {
      id: 56,
      type: "QCM",
      enonce: "Un chauffeur TAXI a-t-il le droit au chômage et aux allocations familiales ?",
      choix: [
        {
          lettre: "A",
          texte: "Il n'a pas le droit au chômage mais a le droit aux allocations familiales",
          correct: true,
        },
        { lettre: "B", texte: "Il a le droit au chômage et aux allocations familiales" },
        { lettre: "C", texte: "Il a le droit au chômage mais pas aux allocations familiales" },
        { lettre: "D", texte: "Il n'a droit ni au chômage ni aux allocations familiales" },
      ],
    },
    {
      id: 57,
      type: "QCM",
      enonce: "Quelle est la couleur du Tarif A ?",
      choix: [
        { lettre: "A", texte: "Blanc", correct: true },
        { lettre: "B", texte: "Orange" },
        { lettre: "C", texte: "Bleu" },
        { lettre: "D", texte: "Vert" },
      ],
    },
    {
      id: 58,
      type: "QCM",
      enonce: "Existe-t-il un tarif minimum de perception pour les courses de TAXI ?",
      choix: [
        { lettre: "A", texte: "Non en aucun cas" },
        { lettre: "B", texte: "Oui", correct: true },
        { lettre: "C", texte: "La nuit uniquement" },
      ],
    },
    {
      id: 59,
      type: "QCM",
      enonce: "Quel est le service compétent pour conventionner un TAXI au TAP ?",
      choix: [
        { lettre: "A", texte: "La CPAM dont dépend l'ADS", correct: true },
        { lettre: "B", texte: "La CPAM dont dépend l'assuré" },
        { lettre: "C", texte: "La CPAM dont dépend le patient" },
        { lettre: "D", texte: "La CPAM du département d'examen TAXI" },
      ],
    },
    {
      id: 60,
      type: "QCM",
      enonce: "Citez les cas dans lesquels on peut céder à titre onéreux une ADS :",
      choix: [
        { lettre: "A", texte: "Liquidation judiciaire", correct: true },
        { lettre: "B", texte: "Décès", correct: true },
        { lettre: "C", texte: "Annulation du permis de conduire" },
        { lettre: "D", texte: "Dans n'importe quel cas" },
      ],
    },
    {
      id: 61,
      type: "QCM",
      enonce: "Quelle est la couleur du globe répétiteur indiquant le tarif B ?",
      choix: [
        { lettre: "A", texte: "Verte" },
        { lettre: "B", texte: "Blanche" },
        { lettre: "C", texte: "Orange", correct: true },
      ],
    },
    {
      id: 62,
      type: "QCM",
      enonce: "Qu'est-ce que le carnet de métrologie ?",
      choix: [
        { lettre: "A", texte: "Un livre", correct: true },
        { lettre: "B", texte: "Un cahier de notes" },
        { lettre: "C", texte: "Un carnet de liaison entre l'installateur du matériel et le taxi", correct: true },
        { lettre: "D", texte: "Une preuve de conformité des équipements spéciaux", correct: true },
      ],
    },
    {
      id: 63,
      type: "QCM",
      enonce:
        "Dans le cadre d'une cession d'ADS délivrée avant le 1er octobre 2014, il est fait dérogation aux délais minimum d'exploitation continue et effective, en cas :",
      choix: [
        { lettre: "A", texte: "De décès", correct: true },
        { lettre: "B", texte: "De départ à la retraite" },
        { lettre: "C", texte: "De retrait du permis de conduire" },
        { lettre: "D", texte: "D'inaptitude médicale définitive à la conduite automobile", correct: true },
      ],
    },
    {
      id: 64,
      type: "QCM",
      enonce: "Quelle autorité décide de la répartition du taux d'augmentation annuel des tarifs ?",
      choix: [
        { lettre: "A", texte: "Le maire" },
        { lettre: "B", texte: "Le président régional" },
        { lettre: "C", texte: "Le préfet du département", correct: true },
        { lettre: "D", texte: "Le responsable du syndicat local" },
      ],
    },
    {
      id: 65,
      type: "QCM",
      enonce: "Parmi la liste ci-dessous, cochez les équipements obligatoires du véhicule taxi :",
      choix: [
        { lettre: "A", texte: "Trousse de secours (CPAM)" },
        { lettre: "B", texte: "Détecteur de radar" },
        { lettre: "C", texte: "Terminal de paiement électronique (TPE)", correct: true },
        { lettre: "D", texte: "GPS" },
      ],
    },
    {
      id: 66,
      type: "QCM",
      enonce: "À quelle périodicité le véhicule taxi doit-il passer le contrôle technique ?",
      choix: [
        { lettre: "A", texte: "Tous les 6 mois" },
        { lettre: "B", texte: "Aucune obligation prévue par la réglementation" },
        { lettre: "C", texte: "2 ans" },
        { lettre: "D", texte: "1 an", correct: true },
      ],
    },
    {
      id: 67,
      type: "QCM",
      enonce: "Dans quels cas puis-je utiliser un véhicule de remplacement ?",
      choix: [
        { lettre: "A", texte: "En cas de panne de mon véhicule", correct: true },
        { lettre: "B", texte: "En cas d'accident de mon véhicule", correct: true },
        { lettre: "C", texte: "En cas de vol des équipements spéciaux de mon véhicule", correct: true },
        { lettre: "D", texte: "En attendant d'avoir mon permis de circuler" },
      ],
    },
  ],
};
  ...
  questions: [
    {
      ...
      enonce: "Que signifie le tarif A ?",
      choix: [
        { lettre: "A", texte: "Course de jour", correct: true },
        {
          lettre: "B",
          texte:
            "Course de nuit, course effectuée le dimanche et les jours fériés ou course sur route effectivement enneigées ou verglacées",
        },
        { lettre: "C", texte: "Trajet aller avec le client et retour à vide à la station" },
      ],
    },
    {
      id: 2,
      type: "QCM",
      enonce: "Quel est le montant de la prise en charge ?",
      choix: [
        { lettre: "A", texte: "4 €", correct: true },
        { lettre: "B", texte: "5 €" },
      ],
    },
    {
      ...
      enonce: "Le supplément bagage est pour :",
      choix: [
        { lettre: "A", texte: "Les valises, ou bagages de taille équivalente, au-delà de trois valises" },
        {
          lettre: "B",
          texte: "Les valises, ou bagages de taille équivalente, au-delà de quatre valises",
          correct: true,
        },
        { lettre: "C", texte: "Les valises, ou bagages de taille équivalente, au-delà de cinq valises" },
      ],
    },
    {
      id: 4,
    ...
    },
    {
      id: 7,
      type: "QCM",
      enonce: "Que signifie le tarif B ?",
      choix: [
        { lettre: "A", texte: "Course de jour" },
        { lettre: "B", texte: "Trajet aller avec le client et retour en charge à la station" },
        {
        ...
        { lettre: "D", texte: "Trajet aller avec le client et retour à vide à la station" },
      ],
    },
    {
      id: 8,
      type: "QCM",
      enonce: "Quelle est le montant de la réservation immédiate ?",
      choix: [
    ...
    },
    {
      id: 9,
      type: "QCM",
      enonce: "Quelle est le montant de la réservation à l'avance ?",
      choix: [
        { lettre: "A", texte: "2€" },
        { lettre: "B", texte: "2,50€" },
        { lettre: "C", texte: "4€", correct: true },
    ...
    },
    {
      id: 10,
      type: "QCM",
      enonce: "La basilique de Notre Dame de Fourvière est-elle inscrite au patrimoine mondial de l'UNESCO ?",
      choix: [
    ...
    },
    {
      id: 11,
      type: "QCM",
      enonce: "Quel est le prix au km du tarif B ?",
      choix: [
        { lettre: "A", texte: "2,31€" },
        { lettre: "B", texte: "1,54€" },
        { lettre: "C", texte: "1,50€", correct: true },
        { lettre: "D", texte: "2,50€" },
      ],
    },
    {
      id: 12,
      type: "QCM",
      enonce: "Où se situe le consulat du Japon ?",
      choix: [
        { lettre: "A", texte: "2/4 rue Carry" },
        { lettre: "B", texte: "131 Boulevard de Stalingrad, 69100", correct: true },
        { lettre: "C", texte: "126 rue Vauban" },
        { lettre: "D", texte: "26 Rue Louis Blanc" },
      ],
    },
    {
      id: 13,
      type: "QCM",
      enonce: "Que signifie le tarif D ?",
      choix: [
        { lettre: "A", texte: "Course de jour" },
        { lettre: "B", texte: "Trajet aller avec le client et retour en charge à la station" },
        {
    ...
    },
    {
      id: 14,
      type: "QCM",
      enonce: "Quel est le tarif maximum de prise en charge sur le département du Rhône par horaire ?",
      choix: [
        { lettre: "A", texte: "35,20€" },
        { lettre: "B", texte: "35,25€" },
        { lettre: "C", texte: "35,30€" },
        { lettre: "D", texte: "40,40€", correct: true },
      ],
    },
    {
      id: 15,
      type: "QCM",
      enonce: "Quelle(s) commune(s) ne fait (font) pas partie(s) de la ZUPC ?",
      choix: [
        { lettre: "A", texte: "Caluire-et-Cuire" },
        { lettre: "B", texte: "Saint-Priest" },
        { lettre: "C", texte: "Chassieu" },
        { lettre: "D", texte: "Villefranche", correct: true },
      ],
    },
    {
      id: 16,
      type: "QCM",
      enonce: "Quel est le prix au km du tarif D ?",
      choix: [
        { lettre: "A", texte: "2,43€" },
        { lettre: "B", texte: "1,54€" },
        { lettre: "C", texte: "1,22€" },
    ...
    },
    {
      id: 17,
      type: "QCM",
      enonce: "Où se situe la chambre régionale d'agriculture ?",
      choix: [
        { lettre: "A", texte: "2/4 rue Carry" },
        { lettre: "B", texte: "23 rue Jean Baldassini", correct: true },
        { lettre: "C", texte: "126 rue Vauban" },
        { lettre: "D", texte: "26 Rue Louis Blanc" },
      ],
    },
    {
      ...
      type: "QCM",
      enonce:
        "Je souhaite m'inscrire sur une liste d'attente pour l'obtention d'une ADS gratuite sur la commune de Dardilly, à qui devrais-je m'adresser ?",
      choix: [
        { lettre: "A", texte: "Mairie de Dardilly" },
        { lettre: "B", texte: "Métropole de Lyon", correct: true },
    ...
    },
    {
      ...
      type: "QCM",
      enonce:
        "Je souhaite m'inscrire sur une liste d'attente pour l'obtention d'une ADS gratuite sur la commune de Genas, à qui devrais-je m'adresser ?",
      choix: [
        { lettre: "A", texte: "Mairie de Genas", correct: true },
    ...
    },
    {
      id: 20,
      type: "QCM",
      enonce: "Un client a oublié un objet dans le véhicule TAXI, où dois-je le déposer ?",
      choix: [
        { lettre: "A", texte: "Je garde l'objet pour moi" },
        {
          lettre: "B",
          texte:
            "Aux services des objets trouvés de la mairie de dépose ou auprès de l'autorité de délivrance de l'ADS dans un délai maximum de 72h",
          correct: true,
        },
        { lettre: "C", texte: "Aux services des objets trouvés dans un délai maximum de 48h" },
        { lettre: "D", texte: "Aux services des objets trouvés dans un délai maximum de 24h" },
      ],
    },
    {
      id: 21,
      type: "QCM",
      enonce: "Où se situe le château de Lacroix-Laval ?",
      choix: [
        { lettre: "A", texte: "Saint-Genis-Laval" },
        { lettre: "B", texte: "Marcy-l'Étoile", correct: true },
        { lettre: "C", texte: "Tassin-la-Demi-Lune" },
        { lettre: "D", texte: "Lyon 9" },
      ],
    },
    {
      id: 22,
      type: "QCM",
      enonce: "Où se situe la station de taxi la plus proche du Musée des Tissus et des Arts Décoratifs ?",
      choix: [
        { lettre: "A", texte: "Station place Bellecour" },
        { lettre: "B", texte: "Station hôtel Sofitel", correct: true },
        { lettre: "C", texte: "Station hôtel Royal" },
        { lettre: "D", texte: "Station Gare Perrache" },
      ],
    },
    {
      id: 23,
      type: "QCM",
      enonce: "Où se trouve la fresque de la Martinière ?",
      choix: [
        { lettre: "A", texte: "Place Sathonnay" },
        { lettre: "B", texte: "Rue de la Martinière", correct: true },
        { lettre: "C", texte: "Avenue Tony Garnier" },
        { lettre: "D", texte: "Boulevard des Canuts" },
      ],
    },
    {
      id: 24,
      type: "QCM",
      enonce: "Le service Taxis de la Métropole de Lyon se trouve :",
      choix: [
        { lettre: "A", texte: "18 rue Créqui Lyon" },
        { lettre: "B", texte: "20 place Charles Béraudier Lyon" },
        { lettre: "C", texte: "Métro Jean Jaurès Lyon 7", correct: true },
        { lettre: "D", texte: "20 place Bellecour" },
      ],
    },
    {
      id: 25,
      type: "QCM",
      enonce: "En cas de location gérance, l'assurance est à la charge :",
      choix: [
        { lettre: "A", texte: "Du loueur", correct: true },
        { lettre: "B", texte: "Du locataire" },
      ],
    },
    {
      id: 26,
      type: "QCM",
      enonce: "Quelle ville a été considérée comme capitale française de la culture ?",
      choix: [
        { lettre: "A", texte: "Lyon" },
        { lettre: "B", texte: "Villeurbanne", correct: true },
        { lettre: "C", texte: "Paris" },
        { lettre: "D", texte: "Le Havre" },
      ],
    },
    {
      id: 27,
      type: "QCM",
      enonce:
        "Je suis convoqué à une commission disciplinaire locale, puis-je me faire assister par quelqu'un de mon choix ?",
      choix: [
        { lettre: "A", texte: "Oui", correct: true },
        { lettre: "B", texte: "Non" },
      ],
    },
    {
      id: 28,
      type: "QCM",
      enonce: "Puis-je transporter des personnes autres que des clients, lors d'une course avec ces derniers ?",
      choix: [
        { lettre: "A", texte: "Oui" },
        { lettre: "B", texte: "Non", correct: true },
      ],
    },
    {
      ...
      type: "QCM",
      enonce:
        "Je dispose d'une licence de Villefranche, je souhaite déposer un article trouvé dans mon véhicule à Lyon 8, je le dépose à :",
      choix: [
        { lettre: "A", texte: "La Métropole de Lyon", correct: true },
        { lettre: "B", texte: "La mairie de Lyon 8" },
        { lettre: "C", texte: "La mairie de Villeurbanne" },
        { lettre: "D", texte: "La mairie de Villefranche" },
      ],
    },
    {
      id: 30,
      type: "QCM",
      enonce: "Je suis à Bron, j'ai une course au départ de Saint-Genis-Laval, j'active mon compteur à :",
      choix: [
        {
          lettre: "A",
          texte:
            "À la dernière station ou à équidistance de la ZUPC ou à la dernière station ou à équidistance de la commune de rattachement du TAXI",
          correct: true,
        },
        { lettre: "B", texte: "Saint-Genis-Laval" },
        { lettre: "C", texte: "Bron" },
        { lettre: "D", texte: "Lyon" },
      ],
    },
    {
      id: 31,
      type: "QCM",
      enonce: "Quel monument figure sur la place des Terreaux ?",
      choix: [
        { lettre: "A", texte: "La statue de Louis XIV" },
        { lettre: "B", texte: "La fontaine Bartholdi", correct: true },
        { lettre: "C", texte: "La statue de Charlemagne" },
        { lettre: "D", texte: "La statue de Bonaparte" },
      ],
    },
    {
      id: 32,
      type: "QCM",
      enonce: "Quel autre monument a été réalisé par Bartholdi ?",
      choix: [
        { lettre: "A", texte: "La statue de Charlemagne" },
        { lettre: "B", texte: "La tour Eiffel" },
        { lettre: "C", texte: "Burj Khalifa" },
        { lettre: "D", texte: "La statue de la Liberté", correct: true },
      ],
    },
    {
      id: 33,
      type: "QCM",
      enonce:
        "Avant d'être enregistré au service en charge des taxis à la Métropole de Lyon, où doit être présenté le contrat de location gérance ?",
      choix: [
        { lettre: "A", texte: "La préfecture" },
    ...
    },
    {
      id: 34,
      type: "QCM",
      enonce: "Quelle commune fait partie de la Métropole de Lyon ?",
      choix: [
        { lettre: "A", texte: "Tarare" },
        { lettre: "B", texte: "Brignais" },
        { lettre: "C", texte: "Sérézin-du-Rhône" },
        { lettre: "D", texte: "Quincieux", correct: true },
      ],
    },
    {
      id: 35,
      type: "QCM",
      enonce: "Que doit faire un chauffeur TAXI qui n'est pas en course et qui stationne sur une place de TAXI ?",
      choix: [
        {
          lettre: "A",
          texte:
            "La station doit avoir 5 places minimum, le lumineux doit être allumé et un disque de stationnement doit être sur le tableau de bord",
        },
        {
          lettre: "B",
          texte:
            "La station doit avoir 4 places minimum, le lumineux doit être allumé et un disque de stationnement doit être sur le tableau de bord",
        },
        {
          lettre: "C",
          texte:
            "La station doit avoir 3 places minimum, le lumineux doit être allumé et un disque de stationnement doit être sur le tableau de bord",
          correct: true,
        },
        {
          lettre: "D",
          texte:
            "La station doit avoir 6 places minimum, 1/3 de la partie arrière peut être utilisée, le lumineux doit être allumé et un disque de stationnement doit être sur le tableau de bord",
        },
      ],
    },
    {
      id: 36,
      type: "QCM",
      enonce: "Où se situe la station de taxi la plus proche des Halles Paul Bocuse ?",
      choix: [
        { lettre: "A", texte: "Boulevard Eugène Deruelle" },
        { lettre: "B", texte: "Rue de Bonnel" },
        { lettre: "C", texte: "Boulevard Vivier Merle", correct: true },
        { lettre: "D", texte: "Rue Servient" },
      ],
    },
    {
      id: 37,
      type: "QCM",
      enonce: "À quelle fréquence se réunit le SIRHA sur Lyon ?",
      choix: [
        { lettre: "A", texte: "1 an" },
        { lettre: "B", texte: "2 ans", correct: true },
        { lettre: "C", texte: "3 ans" },
    ...
    },
    {
      id: 38,
      type: "QCM",
      enonce: "Quelle personnalité publique est originaire de la région lyonnaise ?",
      choix: [
        { lettre: "A", texte: "Anne Roumanoff" },
        { lettre: "B", texte: "Florence Foresti", correct: true },
        { lettre: "C", texte: "Claude Lelouch" },
        { lettre: "D", texte: "Jean Dujardin" },
      ],
    },
    {
      id: 39,
      type: "QCM",
      enonce:
        "À partir de Bellecour, quels axes autoroutiers et/ou périphériques prenez-vous pour aller à Clermont-Ferrand ?",
      choix: [
        { lettre: "A", texte: "A7" },
        { lettre: "B", texte: "M6", correct: true },
        { lettre: "C", texte: "A89", correct: true },
      ],
    },
    {
      id: 40,
      type: "QCM",
      enonce: "Quels sont les critères de véhicule pour exploiter un véhicule taxi ?",
      choix: [
        { lettre: "A", texte: "Véhicule de moins de 7 ans" },
        { lettre: "B", texte: "Véhicule de moins de 10 ans", correct: true },
        {
          lettre: "C",
          texte:
            "Coffre d'un volume minimum de 400 litres pour les véhicules thermiques et 300 litres pour les véhicules électriques",
          correct: true,
        },
        {
          lettre: "D",
          texte:
            "Coffre d'un volume minimum de 500 litres pour les véhicules thermiques et 400 litres pour les véhicules électriques",
        },
      ],
    },
  ],
...
export const bilanExamenTA: ExamenBlanc = {
  ...
  matieres: [bilan_reglementation_taxi_specifique, bilan_reglementation_taxi_locale],
};
