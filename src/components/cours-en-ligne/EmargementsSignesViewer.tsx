...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .signature-center img.formateur-sig { position: absolute; width: 425px; height: 600px; max-width: none; max-height: none; left: 58%; top: 50%; transform: translate(-50%, -50%) scale(0.68); transform-origin: center; filter: contrast(4) brightness(0.55) saturate(1.8); }
