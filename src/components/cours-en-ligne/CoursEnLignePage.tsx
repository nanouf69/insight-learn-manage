...
const CoursEnLignePage = () => {
  ...
  const [modules, setModules] = useState([
    ...
    // VTC sub-modules
    { id: 2, nom: "2a.A. Réglementation T3P — Partie 1/2 (VTC)", eleves: 2, progression: "6%", statut: "Actif" },
    { id: 25, nom: "2b.A. Réglementation T3P — Partie 2/2 (VTC)", eleves: 2, progression: "0%", statut: "Actif" },
    { id: 14, nom: "2c.B. Gestion (VTC)", eleves: 2, progression: "0%", statut: "Actif" },
    { id: 15, nom: "2d.C. Sécurité Routière (VTC)", eleves: 2, progression: "0%", statut: "Actif" },
    { id: 16, nom: "2e.D. Français (VTC)", eleves: 2, progression: "0%", statut: "Actif" },
    { id: 17, nom: "2f.E. Anglais (VTC)", eleves: 2, progression: "0%", statut: "Actif" },
    { id: 18, nom: "2g.F. Réglementation Spécifique (VTC)", eleves: 2, progression: "0%", statut: "Actif" },
    { id: 19, nom: "2h.G. Développement Commercial (VTC)", eleves: 2, progression: "0%", statut: "Actif" },
    // TAXI sub-modules
    { id: 10, nom: "2a.A. Réglementation T3P (TAXI)", eleves: 0, progression: "0%", statut: "Actif" },
    { id: 20, nom: "2b.B. Gestion (TAXI)", eleves: 0, progression: "0%", statut: "Actif" },
    { id: 21, nom: "2c.C. Sécurité Routière (TAXI)", eleves: 0, progression: "0%", statut: "Actif" },
    { id: 22, nom: "2d.D. Français (TAXI)", eleves: 0, progression: "0%", statut: "Actif" },
    { id: 23, nom: "2e.E. Anglais (TAXI)", eleves: 0, progression: "0%", statut: "Actif" },
    { id: 24, nom: "2f.F. Réglementation (TAXI)", eleves: 0, progression: "0%", statut: "Actif" },
    // TA & VA cours groupés
