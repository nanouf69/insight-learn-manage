...
const CGV_SECTIONS = [
  ...
  { title: "ARTICLE 5 — DEDIT ET REMPLACEMENT D'UN PARTICIPANT", text: "En cas de dedit signifie par le Client a FTRANSPORT au moins 7 jours avant le demarrage de la formation, FTRANSPORT offre au Client la possibilite de repousser l'inscription du Stagiaire a une formation ulterieure." },
  { title: "ARTICLE 6 — ANNULATION, ABSENCE OU INTERRUPTION", text: "Tout module commence est du dans son integralite. Les journees d'absence seront remboursees a partir du 8eme jour d'absence avec justificatif medical.\n\nFrais d'annulation (paiement personnel) :\n- Annulation dans les 10 jours ouvrables apres signature : aucun frais (retractation par LRAR).\n- Annulation apres 10 jours ouvrables : frais egaux a 100 % du prix TTC.\n- Non applicable si le stagiaire fournit un certificat medical." },
  { title: "ARTICLE 7 — HORAIRES ET ACCUEIL", text: "Duree quotidienne : 7 heures. Horaires : 9h00-12h00 et 13h00-17h00, avec pause en milieu de chaque demi-journee. Accueil : 9h00-13h00 et 14h00-18h00." },
  { title: "ARTICLE 8 — OBLIGATIONS ET FORCE MAJEURE", text: "FTRANSPORT est tenue a une obligation de moyen et non de resultat. En cas d'echec a l'examen theorique : frais d'examen CMA a la charge de l'eleve (environ 240 EUR). En cas d'echec a l'examen pratique : frais d'examen CMA + location vehicule (environ 200 EUR TTC)." },
  { title: "ARTICLE 9 — PROPRIETE INTELLECTUELLE", text: "L'ensemble des contenus et supports pedagogiques constituent des oeuvres protegees. Le Client et le Stagiaire s'interdisent d'utiliser, transmettre, reproduire ou exploiter ces documents sans accord expres de FTRANSPORT." },
  { title: "ARTICLE 10 — FINANCEMENT CPF", text: "Pour les stagiaires financant via le CPF, les conditions de Mon Compte Formation s'appliquent :\n- Obligation de suivre la formation des expiration du delai de retractation (14 jours).\n- Annulation tardive (< 7 jours ouvres) = perte de 100 % des droits CPF.\n- Absence en presentiel = debit de 100 % du cout sur le compte CPF.\n- Abandon = perte de 100 % des droits CPF, non remboursables.\n- Participation forfaitaire obligatoire depuis le decret du 29 avril 2024." },
  { title: "ARTICLE 11 — DELAI DE RETRACTATION", text: "Conformement a l'article L6353-5 du Code du travail, le Client beneficie d'un delai de retractation de dix jours a compter de la conclusion du contrat de formation professionnelle. Le Client peut exercer son droit de retractation par lettre recommandee avec avis de reception adressee a FTRANSPORT au 86 route de Genas, 69003 Lyon, ou par e-mail a contact@ftransport.fr. Aucun paiement ne sera exige du Client avant l'expiration de ce delai de retractation." },
  { title: "ARTICLE 12 — PROTECTION DES DONNEES PERSONNELLES", text: "Conformement au RGPD et a la loi n°78-17 du 6 janvier 1978, le Stagiaire dispose d'un droit d'acces, de modification, de rectification et d'effacement des donnees personnelles le concernant. Demande d'effacement : contact@ftransport.fr" },
  { title: "ARTICLE 13 — DROIT APPLICABLE", text: "Les presentes CGV sont regies par le droit francais. En cas de litige, les tribunaux de Lyon seront seuls competents." },
];
