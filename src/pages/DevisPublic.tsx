...
const CGV_SECTIONS = [
  ...
  { title: "Dispositions spécifiques aux formations VTC / TAXI et formations continues", text: "Pour les stagiaires inscrits à une formation VTC, TAXI ou formation continue VTC / TAXI :\n\n• En cas d'annulation par le stagiaire pendant la session de formation (formation déjà commencée), aucun remboursement ne pourra être effectué, quel que soit le motif invoqué.\n• En cas d'abandon de la formation par le stagiaire en cours de session, aucun remboursement ne sera accordé, la formation restant intégralement due à FTRANSPORT.\n• Le report de la formation à une session ultérieure ne pourra être accepté que sur présentation d'un certificat médical justifiant l'impossibilité de suivre la session en cours. En l'absence de certificat médical, aucun report ne sera accordé et la formation sera considérée comme due.\n\nLe stagiaire reconnaît avoir été expressément informé de ces conditions au moment de l'acceptation du présent devis." },
  { title: "Horaires et accueil", text: "Sauf indication contraire portée sur la fiche de présentation de la formation et la convocation, la durée quotidienne des formations est fixée à six heures. Sauf indication contraire portée sur la convocation, les formations se déroulent de 09h00 à 12h00 et de 13h00 à 16h00 avec une pause en milieu de chaque demi-journée. Les locaux de FTRANSPORT accueillent les Stagiaires de 09h00 à 12h00 et de 13h00 à 18h00." },
