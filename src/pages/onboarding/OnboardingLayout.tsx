...
export function OnboardingLayout({ children, currentStep, totalSteps, title }: OnboardingLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      {/* Progress bar at the very top with time estimate */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-gray-100 border-b border-gray-200">
        <div className="flex items-center justify-between px-4 py-1.5 text-xs text-gray-600">
          <div className="flex items-center gap-2">
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span>Temps estimé : <span className="font-semibold">~30 min</span></span>
          </div>
