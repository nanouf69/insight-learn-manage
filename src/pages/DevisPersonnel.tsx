...
const FORMATIONS = [
  ...
  { id: "vtc_pratique", label: "Formation pratique VTC", prix: 249, designation: "Formation pratique VTC - 3h de formation en solo ou 6h en groupe avec d'autres eleves, mise a disposition du vehicule a double commande le jour de l'examen pratique", duree: "3h solo ou 6h en groupe", agrement: "n° VTC16-15", type: "vtc" },
