...
DROP TRIGGER IF EXISTS trg_garde_correction_admin_quiz ON public.apprenant_quiz_results;
CREATE TRIGGER trg_garde_correction_admin_quiz
BEFORE UPDATE ON public.apprenant_quiz_results
FOR EACH ROW EXECUTE FUNCTION public.garde_correction_admin_quiz();