...
BEGIN
  ...
  -- Garde-fou anti-doublon : si une connexion active existe et a été créée
  -- il y a moins de 5 secondes, on la réutilise (évite les boucles client).
  ...
  WHERE c.apprenant_id = _apprenant_id
    ...
    AND c.started_at > now() - interval '5 seconds'
